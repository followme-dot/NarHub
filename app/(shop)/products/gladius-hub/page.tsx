...
export default function GladiusHubPage() {
  const { isAuthenticated } = useAuth()
  const [copiedIban, setCopiedIban] = useState(false)
  const [showPayment, setShowPayment] = useState(false)
  const [isOutsideEU, setIsOutsideEU] = useState(false)
  const [showDemoModal, setShowDemoModal] = useState(false)
  const hasImages = platformsWithImages.includes('gladius-hub')
  const firstImageUrl = getFirstPlatformImage('gladius-hub')
  ...
  const product = {
    name: 'GLADIUS HUB',
    icon: '⚔️',
    tagline: 'Web3 Gaming Distribution Platform',
    category: 'Gaming & Metaverse',
    priceMin: 26000000,
    priceMax: 31000000,
    projectedValue2Years: 4500000,
    flagship: false,
    gradient: { from: 'from-red-600', to: 'to-orange-500' }
  }
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-white/80 mb-8 leading-relaxed max-w-xl">
                Steam for Web3. 500+ games catalog, 10% commission vs 30% on Steam, achievement NFTs, and cross-game item interoperability.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                {isAuthenticated ? (
                  ...
                  <Link href="/login?callbackUrl=/products/gladius-hub">
      ...
      <section className="py-12 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { title: '500+ Games', description: 'Extensive Web3 game catalog' },
              { title: '10% Fee', description: 'vs 30% Steam commission' },
              { title: 'Achievement NFTs', description: 'On-chain gaming accomplishments' },
              { title: 'ML Discovery', description: 'AI-powered game recommendations' }
            ].map((feature, index) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-6">About GLADIUS HUB</h2>
            <p className="text-lg text-[#4a4a68] leading-relaxed mb-8">
              GLADIUS HUB is the premier Web3 gaming distribution platform, often described as "Steam for blockchain games." With over 500 titles in our catalog and a revolutionary 10% commission structure (compared to Steam's 30%), we're reshaping how games are distributed and monetized. Our platform enables true digital ownership through achievement NFTs and cross-game item interoperability, creating an interconnected gaming metaverse.
            </p>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Market Overview</h3>
            <p className="text-[#4a4a68] leading-relaxed mb-8">
              The Web3 gaming market is projected to reach $65 billion by 2027, with blockchain games attracting over 2 million daily active wallets. Traditional platforms like Steam maintain a 30% stranglehold on game revenue, creating massive frustration among indie developers. GLADIUS HUB addresses this pain point directly while adding Web3-native features that traditional platforms cannot offer.
            </p>
            ...
            <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-white mb-8`}>
              ...
              <p className="leading-relaxed opacity-95">
                With 500+ games already onboarded and a 10% commission model, GLADIUS HUB captures developer loyalty in an underserved market. Our ML-powered discovery engine increases game visibility by 340% compared to traditional store algorithms. The achievement NFT system has minted over 2 million on-chain accomplishments, creating a new asset class for gamers. Revenue projections show $50M GMV by end of year.
              </p>
            </div>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Competitive Advantage</h3>
            <p className="text-[#4a4a68] leading-relaxed">
              Unlike competitors focused on single chains, GLADIUS HUB supports Ethereum, Polygon, Solana, and Immutable X, covering 95% of the Web3 gaming market. Our cross-game item protocol allows players to use assets across multiple titles, creating network effects that lock in both developers and players. The ML discovery system, trained on 10 million player sessions, delivers personalized recommendations that triple conversion rates compared to category browsing.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Why Invest in GLADIUS HUB?</h2>
            <p className="text-lg text-[#4a4a68]">
              Discover the key reasons why GLADIUS HUB represents an exceptional opportunity for investors and companies looking to dominate Web3 gaming distribution.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              '500+ games, fastest growing Web3 catalog',
              '10% fee disrupts Steam\'s 30% monopoly',
              'Cross-chain support covers 95% of market'
            ].map((reason, index) => (
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              We analyze a real scenario to demonstrate the transformative impact of GLADIUS HUB on indie game developers. This case study illustrates the potential ROI our partners can expect.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-red-50 border border-red-200 rounded-2xl p-6">
                <h4 className="font-bold text-red-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">❌</span> Traditional Platform (Self-hosting/Steam)
                </h4>
                ...
                <ul className="space-y-3">
                  <li className="text-red-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">Self-hosting or 30% Steam cut</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">$24K annual profit on $80K revenue</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
                <h4 className="font-bold text-green-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">✅</span> After (With GLADIUS HUB)
                </h4>
                <p className="text-green-800 text-sm mb-4">
                  Results developers achieve on our platform:
                </p>
                <ul className="space-y-3">
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">•</span>
                    <span className="font-medium">Only 10% platform fee</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">•</span>
                    <span className="font-medium">$180K annual profit (2.5x revenue via ML discovery)</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-center text-white`}>
            ...
            <p className="text-3xl font-bold mb-2">7.5x More Profit</p>
            <p className="text-white/80 text-sm">
              Based on actual indie developer earnings before and after joining GLADIUS HUB
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Who is GLADIUS HUB For?</h2>
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              GLADIUS HUB has been designed with specific organizations in mind that can maximize the value of this platform. If your company fits one of these profiles, GLADIUS HUB may be exactly what you need.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {['Gaming Publishers', 'Blockchain Gaming Studios', 'Metaverse Platforms', 'Gaming VCs'].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              When you acquire GLADIUS HUB, you receive a complete package designed for you to launch and scale your Web3 gaming platform immediately, with no hidden costs or third-party dependencies.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Full access to source code including storefront, payment processing, ML recommendation engine, and cross-game item protocol. All smart contracts included. You own it completely.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                600+ pages of complete technical documentation: platform architecture, ML model training, cross-chain integration, developer onboarding guides, and operational playbooks.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Once purchased, GLADIUS HUB is yours forever. No monthly payments, no royalties, no game or user limits. Deploy for unlimited titles and players.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-3xl p-8 md:p-12 text-white overflow-hidden relative`}>
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Transform Your Business with GLADIUS HUB?</h2>
              <p className="text-white/90 mb-4 max-w-2xl mx-auto text-lg">
                Join the leading companies already using GLADIUS HUB to dominate Web3 gaming distribution and establish lasting competitive advantages in the blockchain gaming market.
              </p>
