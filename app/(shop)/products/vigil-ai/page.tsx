...
export default function VigilAIPage() {
  const { isAuthenticated } = useAuth()
  const [copiedIban, setCopiedIban] = useState(false)
  const [showPayment, setShowPayment] = useState(false)
  const [isOutsideEU, setIsOutsideEU] = useState(false)
  const [showDemoModal, setShowDemoModal] = useState(false)
  const hasImages = platformsWithImages.includes('vigil-ai')
  const firstImageUrl = getFirstPlatformImage('vigil-ai')
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-white/80 mb-8 leading-relaxed max-w-xl">
                Web3 Security AI with GNNs trained on $5B+ in historical hacks. 99.9% detection rate. Real-time protection for exchanges, protocols, and wallets.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                {isAuthenticated ? (
                  ...
                  <Link href="/login?callbackUrl=/products/vigil-ai">
      ...
      <section className="py-12 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { title: 'Graph Neural Networks', description: 'Advanced GNN architecture for threat detection' },
              { title: '99.9% Detection', description: 'Industry-leading accuracy rate' },
              { title: '$50M Prevented', description: 'Fraud and hacks prevented to date' },
              { title: '<100ms Screening', description: 'Real-time transaction analysis' }
            ].map((feature, index) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-6">About VIGIL AI</h2>
            <p className="text-lg text-[#4a4a68] leading-relaxed mb-8">
              VIGIL AI represents the most advanced security solution for the Web3 ecosystem. Built by a team of former security researchers from Google, Chainalysis, and the FBI Cyber Division, VIGIL AI uses cutting-edge Graph Neural Networks (GNNs) to analyze blockchain transactions in real-time, detecting fraud, hacks, and money laundering with unprecedented accuracy. Our models are trained on $5B+ worth of historical attack data, giving us the deepest understanding of threat patterns in the industry.
            </p>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Market Overview</h3>
            <p className="text-[#4a4a68] leading-relaxed mb-8">
              Web3 security is in crisis: $3.8 billion was lost to hacks and fraud in 2022 alone. Exchanges face constant threats from sophisticated attackers, DeFi protocols are exploited through flash loans and reentrancy attacks, and users fall victim to phishing and rug pulls daily. The blockchain security market is projected to reach $15 billion by 2028, with real-time threat detection being the fastest-growing segment.
            </p>
            ...
            <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-white mb-8`}>
              ...
              <p className="leading-relaxed opacity-95">
                VIGIL AI has already prevented over $50M in fraud and hacks for our clients. With a 99.9% detection rate and sub-100ms latency, we provide protection that doesn't compromise user experience. Our enterprise clients include 3 top-20 exchanges and 15+ major DeFi protocols. The B2B SaaS model generates $2M+ ARR with 85% gross margins, and we're just scratching the surface of a $15B market.
              </p>
            </div>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Competitive Advantage</h3>
            <p className="text-[#4a4a68] leading-relaxed">
              Unlike rule-based competitors, VIGIL AI uses Graph Neural Networks that understand the complex relationships between wallets, contracts, and transactions. Our GNN architecture can detect novel attack patterns that have never been seen before, providing zero-day protection. The model improves continuously through online learning, incorporating new threat data in real-time. With 200+ labeled attack patterns and connections to major threat intelligence feeds, VIGIL AI provides the most comprehensive protection available.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Why Invest in VIGIL AI?</h2>
            <p className="text-lg text-[#4a4a68]">
              Discover the key reasons why VIGIL AI represents an exceptional opportunity for investors and companies looking to lead Web3 security.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              '$3.8B lost to hacks annually, massive TAM',
              '99.9% detection, zero-day protection',
              '$50M+ fraud prevented, proven results'
            ].map((reason, index) => (
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              We analyze a real scenario to demonstrate the transformative impact of VIGIL AI on exchange security. This case study illustrates the protection our clients receive.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-red-50 border border-red-200 rounded-2xl p-6">
                <h4 className="font-bold text-red-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">X</span> Without VIGIL AI
                </h4>
                <p className="text-red-800 text-sm mb-4">
                  Typical challenges faced without AI security:
                </p>
                <ul className="space-y-3">
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">-</span>
                    <span className="font-medium">Manual review, slow response</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">-</span>
                    <span className="font-medium">Hacks and losses in millions</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
                <h4 className="font-bold text-green-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">+</span> After (With VIGIL AI)
                </h4>
                ...
                <ul className="space-y-3">
                  <li className="text-green-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">Real-time protection, less than 100ms</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">+</span>
                    <span className="font-medium">99.9% detection, zero breaches</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-center text-white`}>
            ...
            <p className="text-3xl font-bold mb-2">Prevent $M+ in Potential Losses</p>
            <p className="text-white/80 text-sm">
              Based on average hack prevention value for exchange clients
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Who is VIGIL AI For?</h2>
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              VIGIL AI has been designed with specific organizations in mind that can maximize the value of this platform. If your company fits one of these profiles, VIGIL AI may be exactly what you need.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {['Crypto Exchanges', 'DeFi Protocols', 'Institutional Custodians', 'Blockchain Analytics Firms'].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              When you acquire VIGIL AI, you receive a complete package designed for you to deploy enterprise-grade Web3 security immediately, with no hidden costs or third-party dependencies.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Full access to source code including GNN models, real-time inference engine, threat intelligence integrations, and dashboard. All trained models and weights included. You own it completely.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                800+ pages of complete technical documentation: GNN architecture, model training pipelines, API integration guides, threat intelligence feeds, and operational runbooks.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Once purchased, VIGIL AI is yours forever. No monthly payments, no royalties, no transaction limits. Deploy for unlimited wallets and analysis volume.
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="bg-purple-50 border border-purple-200 rounded-2xl p-6 mb-6">
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="pt-3 border-t border-purple-200">
                      <p className="text-purple-700 text-xs font-medium mb-2">Bank and Address:</p>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-3xl p-8 md:p-12 text-white overflow-hidden relative`}>
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Transform Your Business with VIGIL AI?</h2>
              <p className="text-white/90 mb-4 max-w-2xl mx-auto text-lg">
                Join the leading exchanges and protocols already using VIGIL AI to protect billions in assets and establish lasting competitive advantages in Web3 security.
              </p>
