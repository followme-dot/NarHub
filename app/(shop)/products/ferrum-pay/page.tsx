...
export default function FerrumPayPage() {
  const { isAuthenticated } = useAuth()
  const [copiedIban, setCopiedIban] = useState(false)
  const [showPayment, setShowPayment] = useState(false)
  const [isOutsideEU, setIsOutsideEU] = useState(false)
  const [showDemoModal, setShowDemoModal] = useState(false)
  const hasImages = platformsWithImages.includes('ferrum-pay')
  const firstImageUrl = getFirstPlatformImage('ferrum-pay')
  ...
  const product = {
    ...
    flagship: false,
    gradient: { from: 'from-emerald-600', to: 'to-green-500' }
  }
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-white/80 mb-8 leading-relaxed max-w-xl">
                Payment solution accepting 50 cryptos + 150 fiat currencies with only 1% fees vs competitors' 2-3%.
                AI-powered fraud detection included for enterprise-grade security.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                {isAuthenticated ? (
                  ...
                  <Link href="/login?callbackUrl=/products/ferrum-pay">
      ...
      <section className="py-12 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { title: '50 Cryptos', description: 'Bitcoin, Ethereum, stablecoins and more' },
              { title: '150 Fiat Currencies', description: 'Global coverage for worldwide payments' },
              { title: '1% Fee', description: 'vs 2-3% charged by competitors' },
              { title: 'AI Fraud Detection', description: 'Real-time protection against fraud' }
            ].map((feature, index) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-6">About FERRUM PAY</h2>
            <p className="text-lg text-[#4a4a68] leading-relaxed mb-8">
              FERRUM PAY is a next-generation payment gateway that bridges the gap between traditional finance and the crypto economy. Built by a team of former Stripe, PayPal, and Coinbase engineers, this enterprise-grade solution enables any business to accept both cryptocurrency and fiat payments through a single, unified API. Unlike competitors that charge 2-3% per transaction, FERRUM PAY's innovative settlement system allows for just 1% fees, saving merchants thousands annually while expanding their customer base to crypto-native users.
            </p>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Market Overview</h3>
            <p className="text-[#4a4a68] leading-relaxed mb-8">
              The global payment processing market exceeds $100 trillion annually, with crypto payments growing at 45% CAGR. Over 400 million people worldwide hold cryptocurrency, yet only 3% of merchants accept it as payment. This massive gap represents an enormous opportunity for FERRUM PAY. As regulatory clarity improves and stablecoins gain mainstream adoption, businesses that can accept crypto will capture an entirely new customer segment that prefers paying with digital assets.
            </p>
            ...
            <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-white mb-8`}>
              ...
              <p className="leading-relaxed opacity-95">
                The crypto payment gateway market is projected to reach $4.5B by 2028. FERRUM PAY's competitive advantage lies in its hybrid settlement system that reduces fees by 50% compared to competitors like BitPay or Coinbase Commerce. With enterprise clients averaging $2M+ in annual transaction volume, the revenue potential per customer is substantial. The SaaS model with volume-based pricing generates 75% gross margins at scale.
              </p>
            </div>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Competitive Advantage</h3>
            <p className="text-[#4a4a68] leading-relaxed">
              FERRUM PAY's technical moat includes three key innovations: First, a proprietary liquidity aggregation system that sources the best rates across 20+ exchanges in real-time. Second, instant settlement to fiat using stablecoin bridges, eliminating the 2-3 day wait typical with competitors. Third, an AI-powered fraud detection system trained on 50M+ transactions that blocks 99.7% of fraudulent attempts before they complete. These capabilities combined make FERRUM PAY the most cost-effective and secure payment solution in the market.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Why Invest in FERRUM PAY?</h2>
            <p className="text-lg text-[#4a4a68]">
              Discover the key reasons why FERRUM PAY represents an exceptional opportunity for investors and companies looking to enter the payment processing market with a proven, ready-to-scale solution.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              '400M crypto holders, only 3% merchant acceptance',
              '75% gross margin, transaction-based revenue',
              'Exit potential: $200M+ (2-3x Stripe multiples)'
            ].map((reason, index) => (
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              We analyze a real scenario to demonstrate the transformative impact of FERRUM PAY on business results. This case study illustrates the potential ROI our clients can expect.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-red-50 border border-red-200 rounded-2xl p-6">
                <h4 className="font-bold text-red-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">❌</span> Before (Without FERRUM PAY)
                </h4>
                ...
                <ul className="space-y-3">
                  <li className="text-red-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">No crypto payment option</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">Missing crypto-native customer sales</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
                <h4 className="font-bold text-green-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">✅</span> After (With FERRUM PAY)
                </h4>
                ...
                <ul className="space-y-3">
                  <li className="text-green-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">Accept 50 cryptos + 150 fiat currencies</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">•</span>
                    <span className="font-medium">+15% revenue from new customer segment</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-center text-white`}>
            ...
            <p className="text-3xl font-bold mb-2">New Customer Segment Unlocked</p>
            <p className="text-white/80 text-sm">
              +15% revenue increase from crypto-native customers previously unreachable
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Who is FERRUM PAY For?</h2>
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              FERRUM PAY has been designed with specific organizations in mind that can maximize the value of this platform. If your company fits one of these profiles, FERRUM PAY may be exactly what you need.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {['E-commerce Platforms', 'SaaS Companies', 'Marketplaces', 'Enterprise Retailers'].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              When you acquire FERRUM PAY, you receive a complete package designed for you to launch and scale your business immediately, with no hidden costs or third-party dependencies.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Full access to source code including Node.js backend, React dashboard, and mobile SDKs. AI fraud detection models included. No obfuscated code, no proprietary dependencies. You own it completely.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                400+ pages of complete technical documentation: API references, integration guides, compliance frameworks, and operational playbooks for PCI-DSS compliance.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Once purchased, FERRUM PAY is yours forever. No monthly payments, no royalties, no transaction volume limits. Deploy on as many servers as you need.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-3xl p-8 md:p-12 text-white overflow-hidden relative`}>
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Transform Your Business with FERRUM PAY?</h2>
              <p className="text-white/90 mb-4 max-w-2xl mx-auto text-lg">
                Join the leading companies already using FERRUM PAY to accelerate their growth and establish lasting competitive advantages in the payments market.
              </p>
