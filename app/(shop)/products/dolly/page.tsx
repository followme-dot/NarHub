...
import {
  ...
  Users, Lock, TrendingUp, FileText, CreditCard, Rocket, Target, Award, Copy, Check, Database, Activity
} from 'lucide-react'
...
export default function DollyPage() {
  ...
  const hasImages = platformsWithImages.includes('dolly')
  const firstImageUrl = getFirstPlatformImage('dolly')
  ...
  const product = {
    name: 'DOLLY',
    icon: '🎯',
    tagline: 'Decentralized Oracle & Live Liquidity Yield',
    category: 'INFRA Holdings',
    priceMin: 35000000,
    priceMax: 40000000,
    projectedValue2Years: 2500000,
    flagship: false,
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-white/80 mb-8 leading-relaxed max-w-xl">
                Enterprise-grade oracle network and liquidity aggregation system for DeFi protocols. Real-time price feeds, cross-chain data delivery, and automated yield optimization across 15+ blockchain networks.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                {isAuthenticated ? (
                  ...
                  <Link href="/login?callbackUrl=/products/dolly">
      ...
      <section className="py-12 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { title: '15+ Chains', description: 'Multi-chain oracle coverage' },
              { title: '<100ms Latency', description: 'Real-time price feeds' },
              { title: '99.99% Uptime', description: 'Enterprise-grade reliability' },
              { title: '18% APY', description: 'Automated yield optimization' }
            ].map((feature, index) => (
        ...
        <div className="max-w-4xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <p className="text-lg text-[#4a4a68] leading-relaxed mb-8">
              DOLLY (Decentralized Oracle & Live Liquidity Yield) is a next-generation infrastructure platform that combines two critical DeFi components: reliable price oracles and intelligent liquidity management. Built by former Chainlink and Uniswap engineers, DOLLY delivers sub-100ms price feeds across 15+ blockchain networks while simultaneously optimizing yield across lending protocols, DEXs, and liquidity pools. The platform processes over 2 million price updates daily with 99.99% uptime, serving as the backbone for DeFi protocols requiring accurate, tamper-proof data and efficient capital deployment.
            </p>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Market Overview</h3>
            <p className="text-[#4a4a68] leading-relaxed mb-8">
              The blockchain oracle market has grown to approximately €1.5 billion, with Chainlink dominating 60% market share. However, demand for specialized oracle solutions is exploding as DeFi TVL exceeds €80 billion. The liquidity aggregation sector adds another €2.1 billion in market opportunity, with protocols like 1inch and Paraswap proving the model. DOLLY uniquely combines both markets, addressing a €3.6 billion total addressable market that is growing 45% annually as institutional capital flows into DeFi infrastructure.
            </p>
            ...
            <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-white mb-8`}>
              ...
              <p className="leading-relaxed opacity-95">
                The oracle market is projected to reach €4.2 billion by 2027, growing at 45% CAGR. With DeFi protocols paying €150M+ annually for oracle services and liquidity optimization, DOLLY's combined offering captures higher wallet share per client. Current oracle providers charge €50K-500K annually per integration, while DOLLY's competitive €30K base pricing with performance bonuses creates compelling unit economics with 75% gross margins and strong retention.
              </p>
            </div>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Competitive Advantage</h3>
            <p className="text-[#4a4a68] leading-relaxed">
              DOLLY differentiates through its hybrid oracle architecture that combines on-chain and off-chain data sources with cryptographic proofs, achieving 10x lower latency than Chainlink at 40% lower cost. The integrated liquidity yield engine automatically rebalances capital across 200+ DeFi protocols, delivering 18% average APY versus 8% industry standard. Unlike single-purpose competitors, DOLLY's unified platform reduces integration complexity and operational overhead for clients, creating sticky enterprise relationships with 95% annual renewal rates.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Why Invest in DOLLY?</h2>
            <p className="text-lg text-[#4a4a68]">
              Discover the key reasons why DOLLY represents an exceptional opportunity for investors and companies looking to enter the oracle and liquidity infrastructure market.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: '€1.5B oracle market growing 45% annually. DeFi protocols cannot function without reliable price feeds - DOLLY is essential infrastructure.'
              },
              {
                icon: Activity,
                title: 'Recurring Revenue Model',
                description: '€30K-200K per client annually with 95% retention. Oracle fees are operating expenses, not discretionary spend, ensuring stable cash flows.'
              },
              {
                icon: Rocket,
                title: 'Strategic Exit Potential',
                description: 'Prime acquisition target for L1 chains, exchanges, or oracle providers. Comparable exits: API3 ($500M valuation), Band Protocol ($300M peak).'
              }
            ].map((reason, index) => (
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              We analyze a real scenario to demonstrate the transformative impact of DOLLY on DeFi protocol operations. This case study illustrates the potential ROI our clients can expect.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-red-50 border border-red-200 rounded-2xl p-6">
                <h4 className="font-bold text-red-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">Before</span> (Traditional Oracle Setup)
                </h4>
                <p className="text-red-800 text-sm mb-4">
                  Typical challenges faced before implementing DOLLY:
                </p>
                <ul className="space-y-3">
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">-</span>
                    <span className="font-medium">€180K annual oracle costs (Chainlink)</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">-</span>
                    <span className="font-medium">500ms average price feed latency</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">-</span>
                    <span className="font-medium">€2.1M in bad debt from stale prices</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">-</span>
                    <span className="font-medium">8% yield on idle treasury</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
                <h4 className="font-bold text-green-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">After</span> (With DOLLY)
                </h4>
                ...
                <ul className="space-y-3">
                  <li className="text-green-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">€95K annual cost (47% savings)</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">+</span>
                    <span className="font-medium">85ms average latency (6x faster)</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">+</span>
                    <span className="font-medium">Zero bad debt incidents in 18 months</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">+</span>
                    <span className="font-medium">18.2% yield via liquidity optimization</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-center text-white`}>
            ...
            <p className="text-3xl font-bold mb-2">€2.4M+ annual value created</p>
            <p className="text-white/80 text-sm">
              Combining €85K oracle savings, €2.1M bad debt prevention, and €320K additional yield on €3M treasury
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Who is DOLLY For?</h2>
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              DOLLY has been designed with specific organizations in mind that can maximize the value of this infrastructure. If your company fits one of these profiles, DOLLY may be exactly what you need.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { name: 'DeFi Lending Protocols', description: 'Protocols requiring accurate collateral pricing and liquidation data' },
              { name: 'Decentralized Exchanges', description: 'DEXs needing real-time price feeds for AMM and order book systems' },
              { name: 'Yield Aggregators', description: 'Platforms seeking automated yield optimization across protocols' },
              { name: 'Blockchain Foundations', description: 'L1/L2 chains wanting native oracle infrastructure for their ecosystem' }
            ].map((item, index) => (
              <motion.div
                key={index}
              ...
              >
                ...
                <div>
                  <span className="text-[#1a1a2e] font-semibold text-lg block">{item.name}</span>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              When you acquire DOLLY, you receive a complete package designed for you to deploy and scale your oracle and liquidity infrastructure immediately, with no hidden costs or third-party dependencies.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                55,000+ lines of production-ready code including Rust oracle nodes, Solidity smart contracts, TypeScript SDK, and React admin dashboard. Fully audited by Halborn Security.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                450+ pages covering oracle node deployment, data source configuration, smart contract integration, yield strategy customization, and operational monitoring guides.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                45 days of dedicated technical support included. Post-deployment requires 1 Backend + 1 Smart Contract engineer. Full deployment achievable in 4-6 weeks.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                100% ownership with perpetual license. No royalties, no revenue sharing, no usage limits. White-label ready for immediate deployment under your brand.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-3xl p-8 md:p-12 text-white overflow-hidden relative`}>
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Power Your DeFi Infrastructure with DOLLY?</h2>
              <p className="text-white/90 mb-4 max-w-2xl mx-auto text-lg">
                Join the leading DeFi protocols already using DOLLY to deliver reliable price feeds and optimize liquidity yields across their ecosystems.
              </p>
