...
export default function BitbootsPage() {
  const { isAuthenticated } = useAuth()
  const [copiedIban, setCopiedIban] = useState(false)
  const [showPayment, setShowPayment] = useState(false)
  const [isOutsideEU, setIsOutsideEU] = useState(false)
  const [showDemoModal, setShowDemoModal] = useState(false)
  const hasImages = platformsWithImages.includes('bitboots')
  const firstImageUrl = getFirstPlatformImage('bitboots')
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-white/80 mb-8 leading-relaxed max-w-xl">
                AI-powered trading bot executing 20+ strategies across 15 exchanges automatically.
                Backtested with 42% CAGR. Reinforcement learning auto-optimizes parameters weekly.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                {isAuthenticated ? (
                  ...
                  <Link href="/login?callbackUrl=/products/bitboots">
      ...
      <section className="py-12 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { title: 'Advanced AI', description: 'Reinforcement Learning PPO optimizes weekly' },
              { title: '15 Exchanges', description: 'Binance, Coinbase, Kraken, OKX + DEX' },
              { title: 'Backtesting', description: '10 years of data, Sharpe 2.1' },
              { title: 'Mobile Apps', description: 'Native iOS and Android' }
            ].map((feature, index) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-6">About BITBOOTS</h2>
            <p className="text-lg text-[#4a4a68] leading-relaxed mb-8">
              BITBOOTS represents the next generation of algorithmic cryptocurrency trading. Developed over 3 years by a team of engineers from Goldman Sachs, Jane Street, and Google DeepMind, this system combines institutional-grade quantitative trading precision with the accessibility of a modern SaaS platform. Unlike traditional trading bots that require constant manual configuration, BITBOOTS uses advanced Reinforcement Learning (PPO algorithm) to auto-optimize its strategies weekly, adapting to changing market conditions without human intervention.
            </p>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Market Overview</h3>
            <p className="text-[#4a4a68] leading-relaxed mb-8">
              The algorithmic cryptocurrency trading market is experiencing explosive growth. With over 5 million active traders using some form of automation, and daily volume exceeding $50 billion, the demand for sophisticated yet accessible solutions has never been higher. BITBOOTS captures this opportunity by offering institutional trading capabilities to retail traders and small funds, democratizing access to strategies that were previously only available to hedge funds with dozens of quants.
            </p>
            ...
            <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-white mb-8`}>
              ...
              <p className="leading-relaxed opacity-95">
                The TAM for automated trading software will reach $2.1B by 2027, with a CAGR of 12.3%. Currently only 3 serious competitors exist in the real AI bot space (not simple rules), and none offer the combination of Reinforcement Learning + multi-exchange support + native mobile apps that BITBOOTS provides. The SaaS model with $99-499/month subscriptions generates 89% gross margins, with an average LTV of $2,400 per user.
              </p>
            </div>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Competitive Advantage</h3>
            <p className="text-[#4a4a68] leading-relaxed">
              While competitors like 3Commas or Cryptohopper offer rule-based bots, BITBOOTS is the only one implementing true machine learning with auto-optimization. Our PPO model retrains every Sunday with the week's data, adjusting risk parameters, position sizes, and entry/exit signals. The result: a sustained Sharpe Ratio of 2.1 over 10 years of backtesting, significantly outperforming the market benchmark. Additionally, our Rust architecture guarantees execution latencies under 5ms, critical for arbitrage strategies.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Why Invest in BITBOOTS?</h2>
            <p className="text-lg text-[#4a4a68]">
              Discover the key reasons why BITBOOTS represents an exceptional opportunity for investors and companies looking to enter the market with a proven, ready-to-scale solution.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              '5M traders use bots, only 3 serious competitors',
              '89% gross margin, recurring SaaS revenue',
              'Exit potential: $150M+'
            ].map((reason, index) => (
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              We analyze a real scenario to demonstrate the transformative impact of BITBOOTS on business results. This case study illustrates the potential ROI our clients can expect.
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-3xl p-8 mb-8 shadow-sm">
            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-6 text-center">
              📊 Day Trader with $200K Portfolio
            </h3>

            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-red-50 border border-red-200 rounded-2xl p-6">
                <h4 className="font-bold text-red-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">❌</span> Current Situation (Without BITBOOTS)
                </h4>
                ...
                <ul className="space-y-3">
                  <li className="text-red-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">8h/day manual trading</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">$10K/month profit</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
                <h4 className="font-bold text-green-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">✅</span> After (With BITBOOTS)
                </h4>
                ...
                <ul className="space-y-3">
                  <li className="text-green-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">1h/day monitoring</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">•</span>
                    <span className="font-medium">$24K/month profit</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-center text-white`}>
            ...
            <p className="text-3xl font-bold mb-2">+137% more than manual trading</p>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Who is BITBOOTS For?</h2>
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              BITBOOTS has been designed with specific organizations in mind that can maximize the value of this platform. If your company fits one of these profiles, BITBOOTS may be exactly what you need.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {['Exchanges', 'Fintechs', 'Investment Funds'].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              When you acquire BITBOOTS, you receive a complete package designed for you to launch and scale your business immediately, with no hidden costs or third-party dependencies.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Full access to source code including Python, Rust, and React. Trained ML models included. No obfuscated code, no proprietary dependencies. You own it completely.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                500+ pages of complete technical documentation: system architecture, APIs, deployment guides, environment configuration, and operational playbooks.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Once purchased, BITBOOTS is yours forever. No monthly payments, no royalties, no user or transaction limits. Deploy on as many servers as you need.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-3xl p-8 md:p-12 text-white overflow-hidden relative`}>
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Transform Your Business with BITBOOTS?</h2>
              <p className="text-white/90 mb-4 max-w-2xl mx-auto text-lg">
                Join the leading companies already using BITBOOTS to accelerate their growth and establish lasting competitive advantages in the market.
              </p>
