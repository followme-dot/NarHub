...
export default function NardiumDexPage() {
  const { isAuthenticated } = useAuth()
  const [copiedIban, setCopiedIban] = useState(false)
  const [showPayment, setShowPayment] = useState(false)
  const [isOutsideEU, setIsOutsideEU] = useState(false)
  const [showDemoModal, setShowDemoModal] = useState(false)
  const hasImages = platformsWithImages.includes('nardium-dex')
  const firstImageUrl = getFirstPlatformImage('nardium-dex')
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-white/80 mb-8 leading-relaxed max-w-xl">
                Hybrid DEX combining Uniswap V3 concentrated liquidity + order book + cross-chain swaps.
                LPs earn 3-5× more. Triple audited by Trail of Bits, Quantstamp, and OpenZeppelin.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                {isAuthenticated ? (
                  ...
                  <Link href="/login?callbackUrl=/products/nardium-dex">
      ...
      <section className="py-12 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { title: 'Hybrid AMM', description: 'Order book + AMM = best price' },
              { title: 'Cross-Chain', description: 'ETH→BSC in 5 min via LayerZero' },
              { title: 'IL Protection', description: '50% IL reimbursed if LP >30 days' },
              { title: 'Triple Audit', description: '$600K in security audits' }
            ].map((feature, index) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-6">About NARDIUM DEX</h2>
            <p className="text-lg text-[#4a4a68] leading-relaxed mb-8">
              NARDIUM DEX redefines what's possible in decentralized trading. While traditional DEXs like Uniswap operate exclusively with AMM liquidity pools, and centralized exchanges rely on traditional order books, NARDIUM fuses both worlds into a revolutionary hybrid architecture. The result is the best possible price for every trade: the system automatically routes orders between the AMM and order book, finding optimal execution in milliseconds.
            </p>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Market Overview</h3>
            <p className="text-[#4a4a68] leading-relaxed mb-8">
              Trading volume on decentralized exchanges exceeded $730 billion in 2024, and continues to grow exponentially. However, current DEXs suffer from chronic problems: high slippage for large trades, devastating impermanent loss for liquidity providers, and liquidity fragmentation across chains. NARDIUM solves these three fundamental problems with unique technical innovations: Uniswap V3-style concentrated liquidity with an integrated order book, guaranteed IL protection for long-term LPs, and native cross-chain swaps via LayerZero.
            </p>
            ...
            <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-white mb-8`}>
              ...
              <p className="leading-relaxed opacity-95">
                With a target TVL of $100M+ in the first year and 0.3% fees per swap, NARDIUM can generate $3M+ in annual revenue from the exchange alone. Adding premium services like OTC trading, yield farming, and the IL protection program, potential revenue exceeds $10M annually. Exit potential for a DEX with these metrics is in the $200-300M range, as demonstrated by recent acquisitions in the space.
              </p>
            </div>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Competitive Advantage</h3>
            <p className="text-[#4a4a68] leading-relaxed">
              NARDIUM is the only DEX offering all three differentiators simultaneously: (1) Hybrid order book that improves prices 15-25% vs pure AMM, (2) IL Protection that reimburses 50% of impermanent loss for LPs with &gt;30 days staking, and (3) Cross-chain swaps in 5 minutes without external bridges. Additionally, with $600K invested in audits from Trail of Bits, Quantstamp, and OpenZeppelin, it's the most audited DEX in the market.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Why Invest in NARDIUM DEX?</h2>
            <p className="text-lg text-[#4a4a68]">
              Discover the key reasons why NARDIUM DEX represents an exceptional opportunity for investors and companies looking to enter the market with a proven, ready-to-scale solution.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              '$730B annual DEX volume',
              'Only hybrid order book in the market',
              'Exit potential: $200-300M'
            ].map((reason, index) => (
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              We analyze a real scenario to demonstrate the transformative impact of NARDIUM DEX on business results.
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-3xl p-8 mb-8 shadow-sm">
            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-6 text-center">
              📊 LP with $100K Capital
            </h3>

            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-red-50 border border-red-200 rounded-2xl p-6">
                <h4 className="font-bold text-red-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">❌</span> Without NARDIUM DEX
                </h4>
                <ul className="space-y-3">
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">Uniswap V2</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">5.5% APY</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">$5K/year earnings</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
                <h4 className="font-bold text-green-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">✅</span> With NARDIUM DEX
                </h4>
                <ul className="space-y-3">
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">•</span>
                    <span className="font-medium">NARDIUM hybrid system</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">•</span>
                    <span className="font-medium">38% APY</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">•</span>
                    <span className="font-medium">$38K/year earnings</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-center text-white`}>
            ...
            <p className="text-3xl font-bold mb-2">+598% more yield</p>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Who is NARDIUM DEX For?</h2>
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              NARDIUM DEX has been designed with specific organizations in mind that can maximize the value of this platform.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {['Exchanges', 'L1/L2 Chains', 'DeFi Protocols'].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              When you acquire NARDIUM DEX, you receive a complete package designed for immediate deployment.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Smart contracts for 5 chains, complete audit reports, Discord with 2.5K members included. Full ownership with perpetual license.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-[#1a1a2e]">Audit Reports</h3>
              </div>
              <p className="text-[#4a4a68]">
                Complete audit reports from Trail of Bits, Quantstamp, and OpenZeppelin. $600K in security audits included.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Once purchased, NARDIUM DEX is yours forever. No monthly payments, no royalties, no limits.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-3xl p-8 md:p-12 text-white overflow-hidden relative`}>
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Transform DeFi with NARDIUM DEX?</h2>
              <p className="text-white/90 mb-4 max-w-2xl mx-auto text-lg">
                Join the leading exchanges and protocols already using NARDIUM to provide superior trading experiences.
              </p>
