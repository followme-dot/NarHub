...
export default function InfraVaultCorePage() {
  ...
  const hasImages = platformsWithImages.includes('vault')
  const firstImageUrl = getFirstPlatformImage('vault')
              ...
              <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
                ...
                <ul className="space-y-3">
                  <li className="text-green-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">€700K one-time investment</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">+</span>
