...
export default function ArgentumBridgePage() {
  const { isAuthenticated } = useAuth()
  const [copiedIban, setCopiedIban] = useState(false)
  const [showPayment, setShowPayment] = useState(false)
  const [isOutsideEU, setIsOutsideEU] = useState(false)
  const [showDemoModal, setShowDemoModal] = useState(false)
  const hasImages = platformsWithImages.includes('argentum-bridge')
  const firstImageUrl = getFirstPlatformImage('argentum-bridge')
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-white/80 mb-8 leading-relaxed max-w-xl">
                Most secure and fast interoperability infrastructure. Dual-protocol security with LayerZero + Wormhole. $10M insurance. 0.1% fees.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                {isAuthenticated ? (
                  ...
                  <Link href="/login?callbackUrl=/products/argentum-bridge">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              { title: '5 Min Settlement', description: 'Ultra-fast cross-chain transfers' },
              { title: 'Dual Security', description: 'LayerZero + Wormhole protocols' },
              { title: '$10M Insurance', description: 'Full coverage for all transfers' }
            ].map((feature, index) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-6">About ARGENTUM BRIDGE</h2>
            <p className="text-lg text-[#4a4a68] leading-relaxed mb-8">
              ARGENTUM BRIDGE represents the pinnacle of cross-chain interoperability technology. Built by a team of protocol engineers from Chainlink, LayerZero, and Wormhole, this infrastructure solution enables seamless asset transfers across 10+ major blockchain networks with institutional-grade security. Unlike single-protocol bridges that have suffered billions in hacks, ARGENTUM implements a revolutionary dual-protocol verification system that requires consensus from both LayerZero and Wormhole before any transfer is finalized.
            </p>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Market Overview</h3>
            <p className="text-[#4a4a68] leading-relaxed mb-8">
              The cross-chain bridge market has processed over $200 billion in transfers, yet remains plagued by security incidents. Major bridges like Ronin ($625M), Wormhole ($320M), and Nomad ($190M) have suffered devastating exploits. This has created massive demand for secure bridging solutions, with daily bridge volume exceeding $500M. ARGENTUM BRIDGE captures this opportunity by offering the only dual-protocol security architecture in the market, backed by $10M in insurance coverage.
            </p>
            ...
            <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-white mb-8`}>
              ...
              <p className="leading-relaxed opacity-95">
                The cross-chain infrastructure market is projected to reach $15B by 2028, growing at 35% CAGR. Current bridges charge 0.3-0.5% fees, while ARGENTUM's 0.1% fee structure captures volume through competitive pricing. With average daily volume of $50M per bridge, ARGENTUM's fee model generates $18M+ annually. The B2B licensing model to exchanges and DeFi protocols adds additional revenue streams with 85% gross margins.
              </p>
            </div>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Competitive Advantage</h3>
            <p className="text-[#4a4a68] leading-relaxed">
              ARGENTUM BRIDGE is the only solution implementing dual-protocol verification with both LayerZero and Wormhole. This means a transfer requires cryptographic proof from two independent oracle networks before execution, eliminating single points of failure. Our 5-minute settlement time beats competitors by 10-20x, crucial for arbitrage and DeFi applications. The $10M insurance fund, backed by Nexus Mutual, provides institutional-grade protection that no competitor offers.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Why Invest in ARGENTUM BRIDGE?</h2>
            <p className="text-lg text-[#4a4a68]">
              Discover the key reasons why ARGENTUM BRIDGE represents an exceptional opportunity for investors and companies looking to enter the cross-chain infrastructure market.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              '$500M+ daily bridge volume, massive security demand',
              '0.1% fees generate $18M+ annual revenue',
              'Exit potential: $200M+ to major L1/L2 chains'
            ].map((reason, index) => (
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              We analyze a real scenario to demonstrate the transformative impact of ARGENTUM BRIDGE on trading results. This case study illustrates the potential ROI our clients can expect.
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-3xl p-8 mb-8 shadow-sm">
            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-6 text-center">
              📊 Arbitrageur Trading Cross-Chain
            </h3>

            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-red-50 border border-red-200 rounded-2xl p-6">
                <h4 className="font-bold text-red-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">❌</span> Before (Traditional Bridges)
                </h4>
                <p className="text-red-800 text-sm mb-4">
                  Typical challenges faced before using ARGENTUM BRIDGE:
                </p>
                <ul className="space-y-3">
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">30 min bridge settlement time</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">Arbitrage opportunities lost to delays</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
                <h4 className="font-bold text-green-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">✅</span> After (With ARGENTUM BRIDGE)
                </h4>
                ...
                <ul className="space-y-3">
                  <li className="text-green-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">5 min bridge settlement</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">•</span>
                    <span className="font-medium">$457 profit per successful trade</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-center text-white`}>
            ...
            <p className="text-3xl font-bold mb-2">$400K+ annually from captured arbitrage</p>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Who is ARGENTUM BRIDGE For?</h2>
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              ARGENTUM BRIDGE has been designed with specific organizations in mind that can maximize the value of this infrastructure. If your company fits one of these profiles, ARGENTUM BRIDGE may be exactly what you need.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {['L1/L2 Blockchain Networks', 'DeFi Protocols', 'Centralized Exchanges', 'Institutional Trading Desks'].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              When you acquire ARGENTUM BRIDGE, you receive a complete package designed for you to deploy and scale your cross-chain infrastructure immediately, with no hidden costs or third-party dependencies.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Full access to Rust smart contracts, relayer infrastructure, and monitoring systems. Audited by Trail of Bits. No obfuscated code, no proprietary dependencies. You own it completely.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                600+ pages of complete technical documentation: protocol architecture, security model, deployment guides, oracle configuration, and operational runbooks.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Once purchased, ARGENTUM BRIDGE is yours forever. No monthly payments, no royalties, no transaction volume limits. Deploy across as many chains as you need.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-3xl p-8 md:p-12 text-white overflow-hidden relative`}>
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Transform Your Cross-Chain Infrastructure with ARGENTUM BRIDGE?</h2>
              <p className="text-white/90 mb-4 max-w-2xl mx-auto text-lg">
                Join the leading blockchain networks already using ARGENTUM BRIDGE to enable secure, fast cross-chain interoperability for their ecosystems.
              </p>
