...
export default function VeritasIDPage() {
  const { isAuthenticated } = useAuth()
  const [copiedIban, setCopiedIban] = useState(false)
  const [showPayment, setShowPayment] = useState(false)
  const [isOutsideEU, setIsOutsideEU] = useState(false)
  const [showDemoModal, setShowDemoModal] = useState(false)
  const hasImages = platformsWithImages.includes('veritas-id')
  const firstImageUrl = getFirstPlatformImage('veritas-id')
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-white/80 mb-8 leading-relaxed max-w-xl">
                Digital Identity W3C: DIDs, zero-knowledge proofs, 50+ credential issuers. Privacy-preserving verification for the decentralized web.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                {isAuthenticated ? (
                  ...
                  <Link href="/login?callbackUrl=/products/veritas-id">
      ...
      <section className="py-12 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { title: 'W3C DIDs', description: 'Full standard compliance' },
              { title: 'ZK Proofs', description: 'Privacy-preserving verification' },
              { title: '50+ Issuers', description: 'Integrated credential providers' },
              { title: 'Self-Sovereign', description: 'User-controlled identity' }
            ].map((feature, index) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-6">About VERITAS ID</h2>
            <p className="text-lg text-[#4a4a68] leading-relaxed mb-8">
              VERITAS ID is the most comprehensive decentralized identity solution built on W3C standards. In a world where data breaches expose millions of records annually and regulatory requirements like GDPR mandate user data control, VERITAS ID provides the infrastructure for self-sovereign identity. Users control their credentials while organizations can verify claims without accessing underlying personal data through zero-knowledge proofs.
            </p>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Market Overview</h3>
            <p className="text-[#4a4a68] leading-relaxed mb-8">
              The digital identity market is projected to reach $70 billion by 2027, driven by regulatory compliance requirements and the shift to decentralized applications. Traditional identity systems are fundamentally broken: centralized databases create honeypots for hackers, users have no control over their data, and cross-platform verification remains fragmented. VERITAS ID addresses all these pain points with a unified, privacy-preserving solution.
            </p>
            ...
            <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-white mb-8`}>
              ...
              <p className="leading-relaxed opacity-95">
                With 50+ credential issuers already integrated (including government IDs, educational certificates, and professional licenses), VERITAS ID has the largest credential network in the decentralized identity space. Our B2B model charges $0.05-0.50 per verification, with enterprise contracts averaging $500K ARR. The platform processes 2M+ verifications monthly with 99.99% uptime.
              </p>
            </div>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Competitive Advantage</h3>
            <p className="text-[#4a4a68] leading-relaxed">
              Unlike competitors focused on single use cases, VERITAS ID provides a complete identity stack from credential issuance to verification. Our zero-knowledge proof implementation allows users to prove claims (e.g., "I am over 21" or "I have a valid driver's license") without revealing actual data. The 50+ issuer network creates powerful network effects: each new issuer makes the platform more valuable for verifiers, and vice versa.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Why Invest in VERITAS ID?</h2>
            <p className="text-lg text-[#4a4a68]">
              Discover the key reasons why VERITAS ID represents an exceptional opportunity for investors and companies looking to lead the decentralized identity revolution.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              '$70B identity market by 2027',
              '50+ credential issuers, largest network',
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              We analyze a real scenario to demonstrate the transformative impact of VERITAS ID on DeFi protocols. This case study illustrates the compliance and risk mitigation our clients achieve.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-red-50 border border-red-200 rounded-2xl p-6">
                <h4 className="font-bold text-red-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">❌</span> Without VERITAS ID
                </h4>
                <p className="text-red-800 text-sm mb-4">
                  Typical challenges faced without identity verification:
                </p>
                <ul className="space-y-3">
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">No KYC, regulatory risk exposure</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">Potential fines up to $10M+</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
                <h4 className="font-bold text-green-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">✅</span> After (With VERITAS ID)
                </h4>
                ...
                <ul className="space-y-3">
                  <li className="text-green-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">Compliant, privacy-preserving KYC</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">•</span>
                    <span className="font-medium">Zero data breaches, user-controlled</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-center text-white`}>
            ...
            <p className="text-3xl font-bold mb-2">Avoid $10M+ in Potential Fines</p>
            <p className="text-white/80 text-sm">
              Regulatory compliance and risk mitigation for DeFi protocols
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Who is VERITAS ID For?</h2>
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              VERITAS ID has been designed with specific organizations in mind that can maximize the value of this platform. If your company fits one of these profiles, VERITAS ID may be exactly what you need.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {['DeFi Protocols', 'Crypto Exchanges', 'Enterprise Blockchain', 'Government Services'].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              When you acquire VERITAS ID, you receive a complete package designed for you to launch and scale your decentralized identity infrastructure immediately, with no hidden costs or third-party dependencies.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Full access to source code including DID resolver, verifiable credential SDK, ZK proof circuits, and issuer/verifier portals. All cryptographic libraries included. You own it completely.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                700+ pages of complete technical documentation: W3C DID implementation, ZK proof generation, credential schemas, issuer onboarding, and compliance guidelines.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Once purchased, VERITAS ID is yours forever. No monthly payments, no royalties, no verification limits. Deploy for unlimited users and credentials.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-3xl p-8 md:p-12 text-white overflow-hidden relative`}>
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Transform Your Business with VERITAS ID?</h2>
              <p className="text-white/90 mb-4 max-w-2xl mx-auto text-lg">
                Join the leading companies already using VERITAS ID to build compliant, privacy-preserving identity solutions and establish lasting competitive advantages in the decentralized web.
              </p>
