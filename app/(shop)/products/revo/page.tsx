...
export default function InfracoinnPage() {
  ...
  const hasImages = platformsWithImages.includes('revo')
  const firstImageUrl = getFirstPlatformImage('revo')
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-white/80 mb-8 leading-relaxed max-w-xl">
                Tokenize real-world assets with full regulatory compliance. ERC-3643 compliant tokens, investor accreditation module, secondary market ready, and automated dividend distribution.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                {isAuthenticated ? (
                  ...
                  <Link href="/login?callbackUrl=/products/infracoinn">
      ...
      <section className="py-12 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { title: 'ERC-3643 Compliant', description: 'Regulatory-ready token standards' },
              { title: '88,000+ Lines', description: 'Production-ready codebase' },
              { title: 'Secondary Market', description: 'Built-in trading infrastructure' },
              { title: 'Auto Dividends', description: 'Automated yield distribution' }
            ].map((feature, index) => (
        ...
        <div className="max-w-4xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <p className="text-lg text-[#4a4a68] leading-relaxed mb-8">
              INFRACOINN is a comprehensive RWA (Real-World Asset) tokenization platform enabling compliant issuance of security tokens for real estate, bonds, equity, and alternative investments. Built with Solidity, TypeScript, React, Node.js, PostgreSQL, and IPFS, this 88,000+ line codebase handles the entire asset lifecycle from token issuance to secondary market trading, with built-in investor accreditation and regulatory reporting modules.
            </p>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Market Overview</h3>
            <p className="text-[#4a4a68] leading-relaxed mb-8">
              The tokenization of real-world assets represents one of the most significant opportunities in financial technology. Traditional assets worth hundreds of trillions of dollars - real estate, bonds, private equity, and infrastructure - remain largely illiquid and inaccessible to most investors. Security tokens bridge this gap by enabling fractional ownership, 24/7 trading, and automated compliance, while dramatically reducing settlement times and administrative costs.
            </p>
            ...
            <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-white mb-8`}>
              ...
              <p className="leading-relaxed opacity-95">
                The RWA tokenization market is expected to reach $16 trillion by 2030, representing one of the fastest-growing sectors in blockchain technology. Major institutions including BlackRock, JPMorgan, and Goldman Sachs have already launched tokenization initiatives. INFRACOINN positions you to capture this explosive growth with a production-ready platform that would cost $2-4M and 18-24 months to build from scratch.
              </p>
            </div>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Competitive Advantage</h3>
            <p className="text-[#4a4a68] leading-relaxed">
              INFRACOINN stands apart with its ERC-3643 compliant token architecture - the emerging standard for security tokens that major regulators recognize. The platform includes a complete investor accreditation module for KYC/AML compliance, a secondary market infrastructure for peer-to-peer trading, and automated dividend distribution that eliminates manual payment processing. This comprehensive approach means you can launch compliant tokenized assets in 5-8 weeks instead of building for years.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Why Invest in INFRACOINN?</h2>
            <p className="text-lg text-[#4a4a68]">
              Discover the key reasons why INFRACOINN represents an exceptional opportunity for institutions looking to enter the RWA tokenization market.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              '$16T RWA tokenization market by 2030 - massive institutional demand',
              'Save $2-4M and 18-24 months vs building from scratch',
              'ERC-3643 compliance positions you for regulatory approval'
            ].map((reason, index) => (
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              We analyze a real scenario to demonstrate the transformative impact of INFRACOINN on launching tokenized assets. This case study illustrates the potential ROI our clients can expect.
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-3xl p-8 mb-8 shadow-sm">
            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-6 text-center">
              Real Estate Fund Tokenizing Assets
            </h3>

            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-red-50 border border-red-200 rounded-2xl p-6">
                <h4 className="font-bold text-red-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">X</span> Before (Building from Scratch)
                </h4>
                <p className="text-red-800 text-sm mb-4">
                  Typical challenges faced when building in-house:
                </p>
                <ul className="space-y-3">
                  ...
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">-</span>
                    <span className="font-medium">18-24 months time to market</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">-</span>
              ...
              <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
                <h4 className="font-bold text-green-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">+</span> After (With INFRACOINN)
                </h4>
                ...
                <ul className="space-y-3">
                  <li className="text-green-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">5-8 weeks deployment time</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">+</span>
                    <span className="font-medium">ERC-3643 regulatory compliance built-in</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">+</span>
                    <span className="font-medium">Secondary market trading from day one</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-center text-white`}>
            ...
            <p className="text-3xl font-bold mb-2">Save $1-3M+ and 12-18 months</p>
            <p className="text-white/80 text-sm">
              Based on typical enterprise blockchain development costs and timelines
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Who is INFRACOINN For?</h2>
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              INFRACOINN has been designed with specific organizations in mind that can maximize the value of this platform. If your company fits one of these profiles, INFRACOINN may be exactly what you need.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {['Real Estate Funds', 'Investment Banks', 'Private Equity Firms', 'Asset Managers'].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              When you acquire INFRACOINN, you receive a complete package designed for you to deploy and scale your tokenization platform immediately, with no hidden costs or third-party dependencies.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                88,000+ lines of production code including Solidity smart contracts, TypeScript backend, React frontend, Node.js APIs, PostgreSQL schemas, and IPFS integration. No obfuscated code, no proprietary dependencies.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Complete technical documentation covering smart contract architecture, compliance modules, deployment guides, API references, and operational runbooks for your team.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                30 days of technical support included. After that, buyer should have 1 Blockchain Dev + 1 Backend engineer. Deployment takes 5-8 weeks with proper resources.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                100% ownership with perpetual license. Once purchased, INFRACOINN is yours forever. No monthly payments, no royalties, no transaction volume limits. Deploy across as many assets as you need.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-3xl p-8 md:p-12 text-white overflow-hidden relative`}>
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Tokenize Real-World Assets with INFRACOINN?</h2>
              <p className="text-white/90 mb-4 max-w-2xl mx-auto text-lg">
                Join leading real estate funds and investment banks already using INFRACOINN to launch compliant tokenized assets and access the $16T RWA market.
              </p>
              <p className="text-white/70 mb-8 max-w-xl mx-auto">
                Valuation: <span className="font-bold text-white">{formatPrice(product.priceMin)}</span>
                <br />
                <span className="text-sm">Deploy in 5-8 weeks instead of 18-24 months</span>
              </p>
