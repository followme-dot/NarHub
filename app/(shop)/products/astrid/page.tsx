...
export default function AstridPage() {
  ...
  const hasImages = platformsWithImages.includes('astrid')
  const firstImageUrl = getFirstPlatformImage('astrid')
  ...
  const product = {
    name: 'ASTRID',
    icon: '🏦',
    tagline: 'Enterprise Fiat-to-Crypto Rails',
    category: 'Enterprise',
    priceMin: 85000000,
    priceMax: 90000000,
    flagship: true,
    gradient: { from: 'from-blue-700', to: 'to-indigo-600' }
  }
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-white/80 mb-8 leading-relaxed max-w-xl">
                Bank wire to Crypto in less than 10 minutes. $2B volume Year 1. SOC 2 Type II certified. $120M insurance. Institutional-grade.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                {isAuthenticated ? (
                  ...
                  <Link href="/login?callbackUrl=/products/astrid">
      ...
      <section className="py-12 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { title: '<10 Min Settlement', description: 'Wire to crypto' },
              { title: '$2B Volume', description: 'Processed Year 1' },
              { title: 'SOC 2 Type II', description: 'Certified' },
              { title: '$120M Insurance', description: 'Full coverage' }
            ].map((feature, index) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-6">About ASTRID</h2>
            <p className="text-lg text-[#4a4a68] leading-relaxed mb-8">
              ASTRID is the institutional-grade fiat-to-crypto infrastructure that enterprises and financial institutions trust. Our platform enables seamless conversion from traditional bank wires to cryptocurrency in under 10 minutes, with full regulatory compliance, SOC 2 Type II certification, and $120M in insurance coverage. Built by a team of former executives from Goldman Sachs, Stripe, and Coinbase, ASTRID has processed over $2 billion in volume in its first year alone.
            </p>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Market Overview</h3>
            <p className="text-[#4a4a68] leading-relaxed mb-8">
              The fiat-to-crypto on-ramp market is one of the fastest growing segments in financial infrastructure, projected to reach $50B by 2027. Traditional institutions face significant challenges when trying to access cryptocurrency markets: slow settlement times, regulatory uncertainty, counterparty risk, and lack of enterprise-grade security. ASTRID solves all these problems with a compliant, fast, and secure solution that meets the rigorous standards of institutional finance.
            </p>
            ...
            <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-white mb-8`}>
              ...
              <p className="leading-relaxed opacity-95">
                With over $10 trillion in institutional assets seeking crypto exposure, the demand for compliant, fast, and secure fiat-to-crypto rails has never been higher. ASTRID is positioned as the premier enterprise solution, with partnerships already established with 3 of the top 10 global banks. Our revenue model combines transaction fees (0.1-0.3%) with enterprise licensing, generating over $50M ARR and growing 300% year-over-year.
              </p>
            </div>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Competitive Advantage</h3>
            <p className="text-[#4a4a68] leading-relaxed">
              While competitors like Circle or Paxos focus primarily on stablecoin issuance, ASTRID provides the complete infrastructure for institutional crypto adoption. Our sub-10-minute settlement is 10x faster than traditional wire-based solutions. The SOC 2 Type II certification and $120M insurance policy provide the security guarantees that enterprise clients require. Our direct bank integrations eliminate intermediaries, reducing costs and compliance friction for institutional clients.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Why Invest in ASTRID?</h2>
            <p className="text-lg text-[#4a4a68]">
              Discover the key reasons why ASTRID represents an exceptional opportunity for investors and companies looking to enter the market with a proven, ready-to-scale solution.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              '$10T+ institutional assets seeking crypto exposure',
              '$50M+ ARR with 300% YoY growth trajectory',
              'Exit potential: $1B+ as enterprise crypto infrastructure leader'
            ].map((reason, index) => (
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              We analyze a real scenario to demonstrate the transformative impact of ASTRID on enterprise treasury operations. This case study illustrates the potential ROI our clients achieve.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-red-50 border border-red-200 rounded-2xl p-6">
                <h4 className="font-bold text-red-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">❌</span> Before (Traditional Process)
                </h4>
                ...
                <ul className="space-y-3">
                  <li className="text-red-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">Days for crypto purchase</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">Multiple intermediaries required</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
                <h4 className="font-bold text-green-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">✅</span> After (With ASTRID)
                </h4>
                ...
                <ul className="space-y-3">
                  <li className="text-green-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">Less than 10 minutes settlement</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">•</span>
                    <span className="font-medium">Fully compliant, direct integration</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-center text-white`}>
            ...
            <p className="text-3xl font-bold mb-2">Speed + Compliance</p>
            <p className="text-white/80 text-sm">
              Eliminate settlement delays and compliance risks with institutional-grade infrastructure
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Who is ASTRID For?</h2>
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              ASTRID has been designed with specific organizations in mind that can maximize the value of this platform. If your company fits one of these profiles, ASTRID may be exactly what you need.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {['Banks', 'Enterprises', 'Crypto Exchanges'].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              When you acquire ASTRID, you receive a complete package designed for you to launch and scale your business immediately, with no hidden costs or third-party dependencies.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-[#1a1a2e]">Full Platform</h3>
              </div>
              <p className="text-[#4a4a68]">
                Complete enterprise platform including API gateway, admin dashboard, transaction monitoring, and reporting suite. Built with Go, PostgreSQL, and React with microservices architecture.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-[#1a1a2e]">Bank Integrations</h3>
              </div>
              <p className="text-[#4a4a68]">
                Pre-built integrations with major banking networks including SWIFT, SEPA, ACH, and Fedwire. Direct API connections to 50+ banks globally with full documentation.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-[#1a1a2e]">SOC 2 Documentation</h3>
              </div>
              <p className="text-[#4a4a68]">
                Complete SOC 2 Type II compliance documentation, security policies, and audit procedures. Transferable certification with full audit trail and compliance playbooks.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Once purchased, ASTRID is yours forever. No monthly payments, no royalties, no user or transaction limits. Deploy on as many servers as you need.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-3xl p-8 md:p-12 text-white overflow-hidden relative`}>
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Transform Your Business with ASTRID?</h2>
              <p className="text-white/90 mb-4 max-w-2xl mx-auto text-lg">
                Join the leading financial institutions already using ASTRID to accelerate their growth and establish lasting competitive advantages in the crypto economy.
              </p>
