...
export default function TradeMadPage() {
  const { isAuthenticated } = useAuth()
  const [copiedIban, setCopiedIban] = useState(false)
  const [showPayment, setShowPayment] = useState(false)
  const [isOutsideEU, setIsOutsideEU] = useState(false)
  const [showDemoModal, setShowDemoModal] = useState(false)
  const hasImages = platformsWithImages.includes('trade-mad')
  const firstImageUrl = getFirstPlatformImage('trade-mad')
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-white/80 mb-8 leading-relaxed max-w-xl">
                Crypto taxes for 50+ exchanges, 25 countries, IRS Form 8949, DeFi/NFT tracking. The most comprehensive crypto tax solution on the market.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                {isAuthenticated ? (
                  ...
                  <Link href="/login?callbackUrl=/products/trade-mad">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              { title: 'Wash Sale Detection', description: 'Auto-detection algorithms' },
              { title: 'CPA Portal', description: 'Professional accountant access' }
            ].map((feature, index) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-6">About TRADE MAD</h2>
            <p className="text-lg text-[#4a4a68] leading-relaxed mb-8">
              TRADE MAD is the most comprehensive cryptocurrency tax software available, designed by a team of tax attorneys, CPAs, and blockchain engineers. Our platform automatically imports transactions from 50+ exchanges via API, CSV upload, or direct blockchain scanning, then applies the correct tax rules for 25 different jurisdictions. Unlike competitors that only handle simple trades, TRADE MAD fully supports DeFi protocols, NFT transactions, staking rewards, airdrops, and complex scenarios like liquidity pool positions and yield farming.
            </p>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Market Overview</h3>
            <p className="text-[#4a4a68] leading-relaxed mb-8">
              With over 400 million crypto users globally and increasing regulatory enforcement, the crypto tax software market is projected to reach $3.2 billion by 2028. The IRS has sent millions of warning letters to crypto holders, and tax authorities worldwide are implementing mandatory reporting requirements. TRADE MAD addresses this massive compliance gap with enterprise-grade software that scales from individual traders to accounting firms managing thousands of clients.
            </p>
            ...
            <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-white mb-8`}>
              ...
              <p className="leading-relaxed opacity-95">
                The TAM for crypto tax software exceeds $3B by 2028, with B2C subscriptions ($49-299/year) and B2B enterprise licenses ($10K-100K/year) creating diversified revenue streams. Current market leaders like CoinTracker and Koinly have raised $100M+ at $1B+ valuations. TRADE MAD's CPA portal creates sticky enterprise relationships with accounting firms, generating 85% gross margins and minimal churn. The 25-country localization provides global expansion potential.
              </p>
            </div>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Competitive Advantage</h3>
            <p className="text-[#4a4a68] leading-relaxed">
              TRADE MAD is the only crypto tax software with automatic wash sale detection across all exchanges and wallets, a critical feature for U.S. taxpayers. Our proprietary DeFi decoder can interpret complex smart contract interactions that competitors simply mark as "unknown." The CPA Portal with white-label capabilities allows accounting firms to serve crypto clients under their own brand. Additionally, our blockchain scanning technology can reconstruct complete transaction histories even when exchange records are incomplete.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Why Invest in TRADE MAD?</h2>
            <p className="text-lg text-[#4a4a68]">
              Discover the key reasons why TRADE MAD represents an exceptional opportunity for investors looking to capitalize on the mandatory crypto tax compliance market.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              '400M+ crypto users need tax compliance',
              'Recurring SaaS revenue with 85% margins',
              'Exit potential: $100M+ to TurboTax/H&R Block'
            ].map((reason, index) => (
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              We analyze a real scenario to demonstrate the transformative impact of TRADE MAD on crypto tax compliance. This case study illustrates the potential ROI our clients can expect.
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-3xl p-8 mb-8 shadow-sm">
            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-6 text-center">
              📊 Active Trader with $150K Gains
            </h3>

            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-red-50 border border-red-200 rounded-2xl p-6">
                <h4 className="font-bold text-red-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">❌</span> Before (Manual Process)
                </h4>
                <p className="text-red-800 text-sm mb-4">
                  Typical challenges faced before using TRADE MAD:
                </p>
                <ul className="space-y-3">
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">40 hours of manual spreadsheet work</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">$2,000 CPA fees for crypto specialization</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
                <h4 className="font-bold text-green-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">✅</span> After (With TRADE MAD)
                </h4>
                ...
                <ul className="space-y-3">
                  <li className="text-green-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">2 hours to review auto-generated reports</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">•</span>
                    <span className="font-medium">$299/year subscription cost</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-center text-white`}>
            ...
            <p className="text-3xl font-bold mb-2">2,600% return vs manual process</p>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Who is TRADE MAD For?</h2>
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              TRADE MAD has been designed with specific organizations in mind that can maximize the value of this tax compliance platform. If your company fits one of these profiles, TRADE MAD may be exactly what you need.
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              When you acquire TRADE MAD, you receive a complete package designed for you to deploy and scale your crypto tax compliance business immediately, with no hidden costs or third-party dependencies.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Full access to Python backend, React frontend, and tax calculation engines. 50+ exchange integrations included. No obfuscated code, no proprietary dependencies. You own it completely.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                400+ pages of complete technical documentation: tax calculation algorithms, exchange API guides, jurisdiction-specific rules, and CPA portal configuration guides.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Once purchased, TRADE MAD is yours forever. No monthly payments, no royalties, no user limits. Deploy for as many clients and jurisdictions as you need.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-3xl p-8 md:p-12 text-white overflow-hidden relative`}>
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Transform Crypto Tax Compliance with TRADE MAD?</h2>
              <p className="text-white/90 mb-4 max-w-2xl mx-auto text-lg">
                Join the leading accounting firms and tax software companies already using TRADE MAD to serve millions of crypto traders with automated tax compliance.
              </p>
