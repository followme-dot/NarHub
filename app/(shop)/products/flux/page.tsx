...
export default function InfraPayTreasuryPage() {
  ...
  const hasImages = platformsWithImages.includes('flux')
  const firstImageUrl = getFirstPlatformImage('flux')
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-white/80 mb-8 leading-relaxed max-w-xl">
                Enterprise-grade payment infrastructure supporting SWIFT, SEPA, ACH, and Faster Payments rails.
                Multi-currency treasury management with real-time FX rates and automated liquidity optimization.
              </p>
