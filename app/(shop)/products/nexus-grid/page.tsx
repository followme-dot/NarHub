...
export default function NexusGridPage() {
  ...
  const hasImages = platformsWithImages.includes('nexus-grid')
  const firstImageUrl = getFirstPlatformImage('nexus-grid')
  ...
  const product = {
    name: 'NEXUS GRID',
    icon: '🖥️',
    tagline: 'Decentralized GPU Compute',
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-white/80 mb-8 leading-relaxed max-w-xl">
                Decentralized compute with GPUs 50% cheaper than AWS. AI/ML workloads ready with PyTorch and TensorFlow support.
                Network of 1000+ GPUs with per-second billing.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                {isAuthenticated ? (
                  ...
                  <Link href="/login?callbackUrl=/products/nexus-grid">
      ...
      <section className="py-12 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { title: '50% Cheaper', description: 'Than AWS/GCP for GPU compute' },
              { title: '1000+ GPUs', description: 'Distributed network worldwide' },
              { title: 'AI/ML Ready', description: 'PyTorch, TensorFlow pre-installed' },
              { title: 'Per-Second Billing', description: 'Pay only for what you use' }
            ].map((feature, index) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-6">About NEXUS GRID</h2>
            <p className="text-lg text-[#4a4a68] leading-relaxed mb-8">
              NEXUS GRID is a decentralized GPU computing platform that aggregates idle compute resources from data centers, mining farms, and enterprise facilities worldwide. Built by former AWS and Google Cloud engineers, the platform enables AI researchers and companies to access high-performance GPUs at a fraction of the cost of traditional cloud providers. The proprietary orchestration layer ensures enterprise-grade reliability while maintaining the cost advantages of distributed computing.
            </p>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Market Overview</h3>
            <p className="text-[#4a4a68] leading-relaxed mb-8">
              The global GPU cloud market is exploding, driven by AI/ML workloads that require massive parallel processing power. AWS, Google Cloud, and Azure dominate with 80%+ market share, but their pricing remains prohibitively expensive for startups and researchers. The AI boom has created a severe GPU shortage, with waitlists for H100s extending months. NEXUS GRID solves this by unlocking underutilized GPU capacity globally, creating a marketplace that benefits both compute providers and consumers.
            </p>
            ...
            <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-white mb-8`}>
              ...
              <p className="leading-relaxed opacity-95">
                The GPU-as-a-Service market is projected to reach $25B by 2028, growing at 35% CAGR. NEXUS GRID's decentralized model enables 50% lower pricing while maintaining 25% gross margins through efficient resource utilization. With AI training costs reaching $100M+ for frontier models, even large enterprises are seeking alternatives to hyperscaler lock-in. The platform's network effects create strong defensibility as more GPUs join.
              </p>
            </div>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Competitive Advantage</h3>
            <p className="text-[#4a4a68] leading-relaxed">
              NEXUS GRID's technical moat includes three key innovations: First, a proprietary fault-tolerant orchestration system that automatically redistributes workloads when nodes fail, achieving 99.9% uptime across a decentralized network. Second, optimized data transfer protocols that reduce latency by 40% compared to competitors like Vast.ai or Lambda Labs. Third, pre-configured ML environments with PyTorch, TensorFlow, and JAX that eliminate setup friction. The per-second billing model ensures users never pay for idle time, a stark contrast to hourly billing from hyperscalers.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Why Invest in NEXUS GRID?</h2>
            <p className="text-lg text-[#4a4a68]">
              Discover the key reasons why NEXUS GRID represents an exceptional opportunity for investors and companies looking to enter the cloud infrastructure market with a proven, ready-to-scale solution.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              '$25B TAM by 2028, 35% CAGR growth',
              '25% gross margin on compute sales',
              'Exit potential: $300M+ (infrastructure multiples)'
            ].map((reason, index) => (
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              We analyze a real scenario to demonstrate the transformative impact of NEXUS GRID on business results. This case study illustrates the potential ROI our clients can expect.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-red-50 border border-red-200 rounded-2xl p-6">
                <h4 className="font-bold text-red-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">❌</span> Before (Without NEXUS GRID)
                </h4>
                ...
                <ul className="space-y-3">
                  <li className="text-red-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">AWS GPU costs: $50K/month</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">Long waitlists for H100 instances</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
                <h4 className="font-bold text-green-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">✅</span> After (With NEXUS GRID)
                </h4>
                ...
                <ul className="space-y-3">
                  <li className="text-green-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">NEXUS costs: $25K/month</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">•</span>
                    <span className="font-medium">Same performance, instant availability</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-center text-white`}>
            ...
            <p className="text-white/80 text-sm">
              $300K annual savings for a typical AI startup compute budget
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Who is NEXUS GRID For?</h2>
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              NEXUS GRID has been designed with specific organizations in mind that can maximize the value of this platform. If your company fits one of these profiles, NEXUS GRID may be exactly what you need.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {['AI/ML Startups', 'Research Institutions', 'Gaming Companies', 'Rendering Studios'].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              When you acquire NEXUS GRID, you receive a complete package designed for you to launch and scale your business immediately, with no hidden costs or third-party dependencies.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Full access to source code including Go orchestration layer, Python SDK, and React dashboard. Kubernetes configs and Terraform modules included. No obfuscated code, no proprietary dependencies.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                600+ pages of complete technical documentation: system architecture, API references, node onboarding guides, and operational playbooks for running a distributed GPU network.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Once purchased, NEXUS GRID is yours forever. No monthly payments, no royalties, no compute volume limits. Deploy and scale to any size network you need.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-3xl p-8 md:p-12 text-white overflow-hidden relative`}>
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Transform Your Business with NEXUS GRID?</h2>
              <p className="text-white/90 mb-4 max-w-2xl mx-auto text-lg">
                Join the leading companies already using NEXUS GRID to accelerate their growth and establish lasting competitive advantages in the cloud infrastructure market.
              </p>
