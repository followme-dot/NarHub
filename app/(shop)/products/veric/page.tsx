...
export default function InfraComplianceEnginePage() {
  ...
  const product = {
    ...
    icon: '⚖️',
    tagline: 'Regulatory Compliance. Multi-Jurisdiction. Automated.',
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-white/80 mb-8 leading-relaxed max-w-xl">
                Comprehensive compliance platform with KYC/AML workflow automation, sanctions screening (OFAC, UN, EU), transaction monitoring, regulatory reporting (SAR, CTR), and policy rule engine for EU, US, UK, and APAC jurisdictions.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                {isAuthenticated ? (
                  ...
                  <Link href="/login?callbackUrl=/products/infra-compliance-engine">
      ...
      <section className="py-12 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { title: 'KYC/AML', description: 'Automated workflows' },
              { title: 'Sanctions', description: 'OFAC, UN, EU screening' },
              { title: 'Multi-Jurisdiction', description: 'EU, US, UK, APAC' },
              { title: 'SAR/CTR', description: 'Automated reporting' }
            ].map((feature, index) => (
        ...
        <div className="max-w-4xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <p className="text-lg text-[#4a4a68] leading-relaxed mb-8">
              INFRA COMPLIANCE ENGINE is a comprehensive regulatory technology platform designed to automate and streamline the complex world of financial compliance. Built by former compliance officers from major European banks and RegTech engineers, this solution handles the entire compliance lifecycle from customer onboarding (KYC) through ongoing transaction monitoring (AML), sanctions screening, and automated regulatory reporting. The platform supports multi-jurisdictional compliance requirements across the EU (MiCA, AMLD6), US (BSA, OFAC), UK (FCA regulations), and APAC markets, making it ideal for financial institutions operating globally or planning cross-border expansion.
            </p>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Market Overview</h3>
            <p className="text-[#4a4a68] leading-relaxed mb-8">
              The global RegTech market is valued at approximately €12 billion in 2024 and is projected to grow at over 20% annually, reaching €35 billion by 2030. Financial institutions spend an average of €60 million annually on compliance operations, with 40% of that cost attributed to manual processes that can be automated. Recent regulatory changes including MiCA in Europe, evolving AML directives, and increasing enforcement actions have created unprecedented demand for compliance automation solutions. Banks and fintech companies face average fines of €2.5 million per compliance violation, making robust compliance infrastructure not just a legal requirement but a critical business investment.
            </p>
            ...
            <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-white mb-8`}>
              ...
              <p className="leading-relaxed opacity-95">
                The RegTech market is experiencing explosive growth driven by increasing regulatory complexity and digital transformation in financial services. With over 50,000 regulatory changes tracked globally each year and compliance costs rising 15% annually, financial institutions are actively seeking automated solutions. INFRA COMPLIANCE ENGINE addresses a €12 billion market growing at 20%+ CAGR. The platform's multi-jurisdictional capability positions it uniquely for the €3.5 billion cross-border compliance segment, where current solutions remain fragmented and expensive.
              </p>
            </div>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Competitive Advantage</h3>
            <p className="text-[#4a4a68] leading-relaxed">
              INFRA COMPLIANCE ENGINE differentiates through its unified multi-jurisdictional approach, eliminating the need for separate compliance systems per region. While competitors like ComplyAdvantage and Chainalysis focus on specific compliance verticals, INFRA provides end-to-end coverage from KYC through regulatory reporting. The platform's policy rule engine allows compliance teams to implement new regulations within days rather than months, with 95% configuration-based changes requiring no development work. Real-time sanctions screening against OFAC, UN, and EU lists with sub-second response times ensures compliance without impacting customer experience. The solution reduces compliance operational costs by 60-70% compared to manual processes.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Why Invest in INFRA COMPLIANCE ENGINE?</h2>
            <p className="text-lg text-[#4a4a68]">
              Discover the key reasons why INFRA COMPLIANCE ENGINE represents an exceptional opportunity for investors and companies looking to enter the fast-growing RegTech market.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: '€12B RegTech market growing 20%+ annually. Regulatory complexity drives sustained demand for automation solutions.'
              },
              {
                icon: Shield,
                title: 'Recession-Resistant Revenue',
                description: 'Compliance is mandatory regardless of economic conditions. Financial institutions cannot reduce compliance spending during downturns.'
              },
              {
                icon: Rocket,
                title: 'Strong Exit Potential',
                description: 'RegTech acquisitions averaging 8-12x revenue multiples. Major players (Thomson Reuters, LSEG, FIS) actively acquiring compliance solutions.'
              }
            ].map((reason, index) => (
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              We analyze a real scenario to demonstrate the transformative impact of INFRA COMPLIANCE ENGINE on compliance operations. This case study illustrates the potential ROI for a mid-sized European bank.
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-3xl p-8 mb-8 shadow-sm">
            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-6 text-center">
              Mid-Sized European Bank (€5B AUM, 50,000 customers)
            </h3>

            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-red-50 border border-red-200 rounded-2xl p-6">
                <h4 className="font-bold text-red-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">Before</span> Manual Compliance
                </h4>
                <p className="text-red-800 text-sm mb-4">
                  Typical challenges faced before implementing automation:
                </p>
                <ul className="space-y-3">
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">-</span>
                    <span className="font-medium">35 FTE compliance team (€2.8M annual cost)</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">-</span>
                    <span className="font-medium">72-hour average KYC onboarding time</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">-</span>
                    <span className="font-medium">15% false positive rate on alerts</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">-</span>
                    <span className="font-medium">€1.2M regulatory fines (past 3 years)</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
                <h4 className="font-bold text-green-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">After</span> INFRA COMPLIANCE ENGINE
                </h4>
                ...
                <ul className="space-y-3">
                  <li className="text-green-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">12 FTE compliance team (€960K annual cost)</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">+</span>
                    <span className="font-medium">4-hour average KYC onboarding time</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">+</span>
                    <span className="font-medium">2% false positive rate on alerts</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">+</span>
                    <span className="font-medium">Zero regulatory findings in latest audit</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-center text-white`}>
            ...
            <p className="text-3xl font-bold mb-2">€1.84M annual savings (66% cost reduction)</p>
            <p className="text-white/80 text-sm">
              ROI achieved within 8 months of deployment based on client case study data
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Who is INFRA COMPLIANCE ENGINE For?</h2>
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              INFRA COMPLIANCE ENGINE has been designed for specific organizations that can maximize the value of this platform. If your company fits one of these profiles, this solution may be exactly what you need.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { title: 'Banks & Credit Institutions', description: 'Traditional banks seeking to modernize compliance operations' },
              { title: 'Payment Service Providers', description: 'PSPs and EMIs requiring PSD2 and AML compliance' },
              { title: 'Crypto Exchanges & Custodians', description: 'Digital asset platforms needing MiCA-ready compliance' },
              { title: 'RegTech Consolidators', description: 'Strategic buyers building compliance platform portfolios' }
            ].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              When you acquire INFRA COMPLIANCE ENGINE, you receive a complete package designed for you to deploy and operate your compliance infrastructure immediately, with no hidden costs or third-party dependencies.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                35,000+ lines of TypeScript and Python. Includes KYC workflow engine, AML monitoring system, sanctions screening integration (OFAC, UN, EU lists), and SAR/CTR automated reporting modules. Elasticsearch-powered for sub-second screening.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-[#1a1a2e]">Compliance Documentation</h3>
              </div>
              <p className="text-[#4a4a68]">
                400+ pages of technical documentation plus regulatory mapping guides for EU (MiCA, AMLD6), US (BSA, OFAC), UK (FCA), and APAC jurisdictions. Includes policy templates and audit trail specifications.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                45 days of technical support included for deployment and configuration. After transition, recommended team: 1 Compliance Engineer + 1 Backend Developer. Full deployment typically takes 6-10 weeks.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                100% ownership with perpetual license. No royalties, no per-transaction fees, no user limits. Includes rights to modify, white-label, and resell as part of your own compliance offerings.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-3xl p-8 md:p-12 text-white overflow-hidden relative`}>
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Transform Your Compliance Infrastructure?</h2>
              <p className="text-white/90 mb-4 max-w-2xl mx-auto text-lg">
                Join leading financial institutions already using INFRA COMPLIANCE ENGINE to automate KYC, AML, and regulatory reporting across multiple jurisdictions.
              </p>
