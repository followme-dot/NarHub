  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Why Invest in VERIC?</h2>
            <p className="text-lg text-[#4a4a68]">
              Discover the key reasons why VERIC represents an exceptional opportunity for investors and companies looking to enter the fast-growing RegTech market.
            </p>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              We analyze a real scenario to demonstrate the transformative impact of VERIC on compliance operations. This case study illustrates the potential ROI for a mid-sized European bank.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
                <h4 className="font-bold text-green-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">After</span> VERIC
                </h4>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Who is VERIC For?</h2>
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              VERIC has been designed for specific organizations that can maximize the value of this platform. If your company fits one of these profiles, this solution may be exactly what you need.
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              When you acquire VERIC, you receive a complete package designed for you to deploy and operate your compliance infrastructure immediately, with no hidden costs or third-party dependencies.
            </p>
          </div>
          ...
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-3xl p-8 md:p-12 text-white overflow-hidden relative`}>
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-white/90 mb-4 max-w-2xl mx-auto text-lg">
                Join leading financial institutions already using VERIC to automate KYC, AML, and regulatory reporting across multiple jurisdictions.
              </p>
