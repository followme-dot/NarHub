...
export default function TributumPage() {
  const { isAuthenticated } = useAuth()
  const [copiedIban, setCopiedIban] = useState(false)
  const [showPayment, setShowPayment] = useState(false)
  const [isOutsideEU, setIsOutsideEU] = useState(false)
  const [showDemoModal, setShowDemoModal] = useState(false)
  const hasImages = platformsWithImages.includes('tributum')
  const firstImageUrl = getFirstPlatformImage('tributum')
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-white/80 mb-8 leading-relaxed max-w-xl">
                Crypto tax software for 25 countries with accountant dashboard and DeFi tracking.
                Auto-import from 50+ exchanges with full NFT and DeFi support.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                {isAuthenticated ? (
                  ...
                  <Link href="/login?callbackUrl=/products/tributum">
      ...
      <section className="py-12 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { title: '25 Countries', description: 'Global tax jurisdiction coverage' },
              { title: 'Accountant Portal', description: 'White-label ready for firms' },
              { title: '50+ Exchanges', description: 'Auto-import transaction history' },
              { title: 'DeFi/NFT Support', description: 'Full protocol coverage' }
            ].map((feature, index) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-6">About TRIBUTUM</h2>
            <p className="text-lg text-[#4a4a68] leading-relaxed mb-8">
              TRIBUTUM is a comprehensive crypto tax calculation and reporting platform designed for both individual investors and accounting professionals. Built by a team of former Big 4 tax specialists and fintech engineers, the platform automates the complex process of calculating capital gains, income, and other taxable events across cryptocurrency transactions. With support for 25 countries' tax regulations and automatic data import from 50+ exchanges, TRIBUTUM eliminates hours of manual work while ensuring compliance.
            </p>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Market Overview</h3>
            <p className="text-[#4a4a68] leading-relaxed mb-8">
              As cryptocurrency adoption accelerates globally, tax authorities are increasing enforcement and demanding accurate reporting. Over 300 million people now hold cryptocurrency, but most struggle with tax compliance due to the complexity of tracking thousands of transactions across multiple exchanges and DeFi protocols. The crypto tax software market is projected to reach $1.5B by 2027, driven by regulatory pressure and the growing sophistication of crypto portfolios that include staking, lending, and NFTs.
            </p>
            ...
            <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-white mb-8`}>
              ...
              <p className="leading-relaxed opacity-95">
                The crypto tax software market is growing at 25% CAGR as governments worldwide implement reporting requirements. TRIBUTUM's B2B focus on accounting firms creates a highly scalable distribution model, with each firm serving hundreds of clients. The white-label accountant portal enables firms to offer crypto tax services under their own brand, creating strong lock-in. Average revenue per accounting firm customer exceeds $20K annually, with 85% gross margins on the SaaS model.
              </p>
            </div>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Competitive Advantage</h3>
            <p className="text-[#4a4a68] leading-relaxed">
              TRIBUTUM's technical moat includes three key innovations: First, the most comprehensive DeFi protocol coverage in the market, with support for 200+ protocols across Ethereum, Solana, and other chains, automatically categorizing complex transactions like liquidity provision and yield farming. Second, a white-label accountant portal that enables tax firms to manage hundreds of clients efficiently with team collaboration features. Third, multi-jurisdiction support with tax-loss harvesting optimization that can save users thousands annually. Unlike competitors focused only on the US market, TRIBUTUM's global coverage opens a much larger addressable market.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Why Invest in TRIBUTUM?</h2>
            <p className="text-lg text-[#4a4a68]">
              Discover the key reasons why TRIBUTUM represents an exceptional opportunity for investors and companies looking to enter the crypto tax software market with a proven, ready-to-scale solution.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              '300M crypto holders need tax compliance',
              '85% gross margin, recurring SaaS revenue',
              'Exit potential: $100M+ (fintech tax multiples)'
            ].map((reason, index) => (
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              We analyze a real scenario to demonstrate the transformative impact of TRIBUTUM on business results. This case study illustrates the potential ROI our clients can expect.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-red-50 border border-red-200 rounded-2xl p-6">
                <h4 className="font-bold text-red-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">❌</span> Before (Without TRIBUTUM)
                </h4>
                ...
                <ul className="space-y-3">
                  <li className="text-red-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">Manual calculations, hours per client</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">High error risk with complex DeFi</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
                <h4 className="font-bold text-green-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">✅</span> After (With TRIBUTUM)
                </h4>
                ...
                <ul className="space-y-3">
                  <li className="text-green-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">Automated import and calculation</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">•</span>
                    <span className="font-medium">Accurate, audit-ready reports</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-center text-white`}>
            ...
            <p className="text-3xl font-bold mb-2">10x Efficiency Improvement</p>
            <p className="text-white/80 text-sm">
              Process 10x more clients with the same team, dramatically increasing revenue per accountant
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Who is TRIBUTUM For?</h2>
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              TRIBUTUM has been designed with specific organizations in mind that can maximize the value of this platform. If your company fits one of these profiles, TRIBUTUM may be exactly what you need.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {['Accounting Firms', 'Tax Software Companies', 'Crypto Exchanges', 'Financial Advisors'].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              When you acquire TRIBUTUM, you receive a complete package designed for you to launch and scale your business immediately, with no hidden costs or third-party dependencies.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Full access to source code including Python backend, React dashboard, and exchange API integrations. Tax calculation engines for all 25 supported countries included. No obfuscated code, no proprietary dependencies.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                400+ pages of complete technical documentation: tax calculation methodologies, exchange integration guides, white-label setup instructions, and compliance frameworks for each jurisdiction.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Once purchased, TRIBUTUM is yours forever. No monthly payments, no royalties, no user or client limits. Deploy on as many servers as you need.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-3xl p-8 md:p-12 text-white overflow-hidden relative`}>
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Transform Your Business with TRIBUTUM?</h2>
              <p className="text-white/90 mb-4 max-w-2xl mx-auto text-lg">
                Join the leading companies already using TRIBUTUM to accelerate their growth and establish lasting competitive advantages in the crypto tax compliance market.
              </p>
