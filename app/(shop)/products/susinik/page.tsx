...
export default function SusinikPage() {
  const { isAuthenticated } = useAuth()
  const [copiedIban, setCopiedIban] = useState(false)
  const [showPayment, setShowPayment] = useState(false)
  const [isOutsideEU, setIsOutsideEU] = useState(false)
  const [showDemoModal, setShowDemoModal] = useState(false)
  const hasImages = platformsWithImages.includes('susinik')
  const firstImageUrl = getFirstPlatformImage('susinik')
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-white/80 mb-8 leading-relaxed max-w-xl">
                Carbon credits with AI-verification, satellite proof, and 95% accuracy.
                Tokenized on blockchain for transparent, immutable audit trails.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                {isAuthenticated ? (
                  ...
                  <Link href="/login?callbackUrl=/products/susinik">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              { title: 'Tokenized Credits', description: 'On-chain transparency' },
              { title: 'ESG Reports', description: 'Automated compliance reporting' },
              { title: 'Audit Trail', description: 'Immutable verification history' }
            ].map((feature, index) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-6">About SUSINIK</h2>
            <p className="text-lg text-[#4a4a68] leading-relaxed mb-8">
              SUSINIK revolutionizes the carbon credit market by combining satellite imagery analysis with advanced AI to verify carbon sequestration claims with unprecedented accuracy. Built by a team of climate scientists from NASA, MIT, and former Google Earth engineers, this platform addresses the $2B+ problem of fraudulent carbon credits that plague the voluntary carbon market. Every credit issued through SUSINIK is backed by verifiable satellite data and permanently recorded on-chain.
            </p>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Market Overview</h3>
            <p className="text-[#4a4a68] leading-relaxed mb-8">
              The voluntary carbon market reached $2B in 2023 and is projected to grow to $50B+ by 2030 as corporations face increasing pressure to meet net-zero commitments. However, studies show that up to 90% of rainforest carbon offsets are worthless due to verification failures. This credibility crisis has created massive demand for technology-verified credits that can withstand regulatory scrutiny. SUSINIK provides the solution enterprises need to confidently meet their ESG commitments.
            </p>
            ...
            <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-white mb-8`}>
              ...
              <p className="leading-relaxed opacity-95">
                The carbon credit verification market is projected to reach $5B by 2030 as regulatory requirements tighten globally. SUSINIK's AI-verification technology positions it to capture significant market share in this rapidly growing sector. With enterprise clients paying $50K-500K annually for verified carbon portfolios and automated ESG reporting, the revenue potential is substantial. The platform's blockchain integration also opens opportunities in the emerging tokenized carbon credit market.
              </p>
            </div>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Competitive Advantage</h3>
            <p className="text-[#4a4a68] leading-relaxed">
              SUSINIK's technical moat includes three key innovations: First, a proprietary satellite imagery analysis model trained on 10+ years of deforestation data that achieves 95% accuracy in detecting forest cover changes, far exceeding manual verification methods. Second, blockchain tokenization that creates a permanent, auditable record of every credit from issuance to retirement. Third, automated ESG report generation that saves corporations hundreds of hours of manual compliance work. No competitor offers this end-to-end solution combining AI verification, blockchain transparency, and automated reporting.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Why Invest in SUSINIK?</h2>
            <p className="text-lg text-[#4a4a68]">
              Discover the key reasons why SUSINIK represents an exceptional opportunity for investors and companies looking to enter the carbon credit verification market with a proven, ready-to-scale solution.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              '$50B carbon market by 2030, credibility crisis creating demand',
              '70% gross margin on verification services',
              'Exit potential: $250M+ (ESG/climate tech multiples)'
            ].map((reason, index) => (
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              We analyze a real scenario to demonstrate the transformative impact of SUSINIK on business results. This case study illustrates the potential ROI our clients can expect.
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-3xl p-8 mb-8 shadow-sm">
            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-6 text-center">
              🏢 Corporation ESG Compliance
            </h3>

            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-red-50 border border-red-200 rounded-2xl p-6">
                <h4 className="font-bold text-red-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">❌</span> Before (Without SUSINIK)
                </h4>
                ...
                <ul className="space-y-3">
                  <li className="text-red-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">Manual audits costing $100K+/year</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">Risk of purchasing invalid credits</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
                <h4 className="font-bold text-green-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">✅</span> After (With SUSINIK)
                </h4>
                ...
                <ul className="space-y-3">
                  <li className="text-green-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">Automated verification, real-time</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">•</span>
                    <span className="font-medium">95% accuracy, blockchain-verified</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-center text-white`}>
            ...
            <p className="text-3xl font-bold mb-2">Trust + Cost Savings</p>
            <p className="text-white/80 text-sm">
              Eliminate audit costs while gaining verifiable, defensible ESG compliance
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Who is SUSINIK For?</h2>
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              SUSINIK has been designed with specific organizations in mind that can maximize the value of this platform. If your company fits one of these profiles, SUSINIK may be exactly what you need.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {['Fortune 500 Companies', 'Carbon Credit Registries', 'ESG Investment Funds', 'Government Agencies'].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              When you acquire SUSINIK, you receive a complete package designed for you to launch and scale your business immediately, with no hidden costs or third-party dependencies.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Full access to source code including Python ML models, Solidity smart contracts, and React dashboard. Pre-trained satellite analysis models included. No obfuscated code, no proprietary dependencies.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                450+ pages of complete technical documentation: ML model architecture, blockchain integration guides, ESG reporting templates, and regulatory compliance frameworks.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Once purchased, SUSINIK is yours forever. No monthly payments, no royalties, no verification volume limits. Deploy on as many servers as you need.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-3xl p-8 md:p-12 text-white overflow-hidden relative`}>
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Transform Your Business with SUSINIK?</h2>
              <p className="text-white/90 mb-4 max-w-2xl mx-auto text-lg">
                Join the leading companies already using SUSINIK to accelerate their growth and establish lasting competitive advantages in the carbon credit market.
              </p>
