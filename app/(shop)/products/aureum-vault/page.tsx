...
export default function AureumVaultPage() {
  const { isAuthenticated } = useAuth()
  const [copiedIban, setCopiedIban] = useState(false)
  const [showPayment, setShowPayment] = useState(false)
  const [isOutsideEU, setIsOutsideEU] = useState(false)
  const [showDemoModal, setShowDemoModal] = useState(false)
  const hasImages = platformsWithImages.includes('aureum-vault')
  const firstImageUrl = getFirstPlatformImage('aureum-vault')
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <div className="flex flex-wrap items-center gap-3 mb-6">
                ...
                {product.flagship && (
                  <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white text-amber-600 text-sm font-bold backdrop-blur-sm">
                    <Star className="w-4 h-4" /> FLAGSHIP
                  </span>
                )}
              </div>
              ...
              <p className="text-white/80 mb-8 leading-relaxed max-w-xl">
                Institutional custody with Fireblocks MPC, $100M insurance, SOC 2 Type II certification. The most secure way for institutions to hold digital assets.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                {isAuthenticated ? (
                  ...
                  <Link href="/login?callbackUrl=/products/aureum-vault">
      ...
      <section className="py-12 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { title: 'SOC 2 Type II', description: 'Ernst & Young certified compliance' },
              { title: '$100M Insurance', description: 'Full coverage for all assets' },
              { title: 'MPC + HSM', description: 'Fireblocks + AWS CloudHSM' },
              { title: '20+ Chains', description: 'Multi-chain support' }
            ].map((feature, index) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-6">About AUREUM VAULT</h2>
            <p className="text-lg text-[#4a4a68] leading-relaxed mb-8">
              AUREUM VAULT is the premier institutional-grade cryptocurrency custody solution, built by former executives from Fireblocks, BitGo, and Coinbase Custody. Our platform combines cutting-edge Multi-Party Computation (MPC) technology with Hardware Security Modules (HSM) to provide the most secure custody infrastructure available. Unlike competitors that rely on single-signature or basic multi-sig solutions, AUREUM implements threshold cryptography where private keys never exist in complete form, eliminating single points of compromise.
            </p>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Market Overview</h3>
            <p className="text-[#4a4a68] leading-relaxed mb-8">
              The institutional crypto custody market is experiencing exponential growth as hedge funds, family offices, pension funds, and corporate treasuries allocate to digital assets. With over $500 billion in institutional AUM seeking qualified custody solutions, the market is projected to reach $16 billion by 2028. Regulatory requirements from the SEC, FINRA, and global regulators mandate that institutional investors use qualified custodians, creating sustained demand for compliant custody infrastructure.
            </p>
            ...
            <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-white mb-8`}>
              ...
              <p className="leading-relaxed opacity-95">
                The custody market charges 0.1-0.5% of AUM annually. With AUREUM's target of $5B AUM within 24 months of deployment, annual recurring revenue potential exceeds $25M at 0.5% fees. The enterprise licensing model to banks and family offices adds B2B revenue streams with 90% gross margins. Strategic acquirers include major banks (custody divisions), crypto exchanges, and traditional custodians like BNY Mellon or State Street seeking crypto capabilities.
              </p>
            </div>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Competitive Advantage</h3>
            <p className="text-[#4a4a68] leading-relaxed">
              AUREUM VAULT is the only custody solution with SOC 2 Type II certification from Ernst & Young combined with $100M insurance coverage from Lloyd's of London. Our dual-layer security using Fireblocks MPC and AWS CloudHSM provides redundant protection that no competitor matches. The platform supports 20+ blockchain networks with native staking integration, generating additional yield for clients. Our regulatory-first approach with pre-built compliance modules for SEC, FINRA, MAS, and FCA requirements makes AUREUM the only custody solution ready for global institutional deployment.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Why Invest in AUREUM VAULT?</h2>
            <p className="text-lg text-[#4a4a68]">
              Discover the key reasons why AUREUM VAULT represents an exceptional opportunity for investors seeking exposure to the institutional crypto infrastructure market.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              '$500B+ institutional AUM seeking qualified custody',
              '0.5% AUM fees generate $25M+ ARR at scale',
              'Exit potential: $300M+ to banks/custodians'
            ].map((reason, index) => (
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              We analyze a real scenario to demonstrate the transformative impact of AUREUM VAULT on institutional crypto operations. This case study illustrates the potential ROI our clients can expect.
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-3xl p-8 mb-8 shadow-sm">
            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-6 text-center">
              📊 Hedge Fund with $200M AUM
            </h3>

            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-red-50 border border-red-200 rounded-2xl p-6">
                <h4 className="font-bold text-red-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">❌</span> Before (Self-Custody)
                </h4>
                <p className="text-red-800 text-sm mb-4">
                  Typical challenges faced before using AUREUM VAULT:
                </p>
                <ul className="space-y-3">
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">$350K/year operational costs</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">Catastrophic single-point-of-failure risk</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
                <h4 className="font-bold text-green-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">✅</span> After (With AUREUM VAULT)
                </h4>
                ...
                <ul className="space-y-3">
                  <li className="text-green-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">$800K/year custody + staking fees</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">•</span>
                    <span className="font-medium">+$6.4M staking profit (3.2% APY)</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-center text-white`}>
            ...
            <p className="text-3xl font-bold mb-2">8x return through staking yield + security</p>
            <p className="text-white/80 text-sm">
              Based on current client analysis and conservative market projections
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Who is AUREUM VAULT For?</h2>
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              AUREUM VAULT has been designed with specific organizations in mind that can maximize the value of this institutional-grade custody solution. If your company fits one of these profiles, AUREUM VAULT may be exactly what you need.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {['Hedge Funds & Asset Managers', 'Family Offices', 'Banks & Financial Institutions', 'Corporate Treasuries'].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              When you acquire AUREUM VAULT, you receive a complete package designed for you to deploy and scale your institutional custody operations immediately, with no hidden costs or third-party dependencies.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Full access to MPC coordination layer, HSM integration, and custody APIs. Audited by Trail of Bits and NCC Group. No obfuscated code, no proprietary dependencies. You own it completely.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                800+ pages of complete technical documentation: security architecture, MPC protocols, HSM configuration, compliance frameworks, and SOC 2 audit preparation guides.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Once purchased, AUREUM VAULT is yours forever. No monthly payments, no royalties, no AUM-based fees. Deploy for as many clients and as much AUM as you need.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-3xl p-8 md:p-12 text-white overflow-hidden relative`}>
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Transform Institutional Custody with AUREUM VAULT?</h2>
              <p className="text-white/90 mb-4 max-w-2xl mx-auto text-lg">
                Join the leading financial institutions already using AUREUM VAULT to secure billions in digital assets with institutional-grade custody infrastructure.
              </p>
