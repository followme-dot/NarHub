...
export default function AetherHubPage() {
  const { isAuthenticated } = useAuth()
  const [copiedIban, setCopiedIban] = useState(false)
  const [showPayment, setShowPayment] = useState(false)
  const [isOutsideEU, setIsOutsideEU] = useState(false)
  const [showDemoModal, setShowDemoModal] = useState(false)
  const hasImages = platformsWithImages.includes('aether-hub')
  const firstImageUrl = getFirstPlatformImage('aether-hub')
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <div className="flex flex-wrap items-center gap-3 mb-6">
                ...
                {product.flagship && (
                  <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-yellow-400/90 text-yellow-900 text-sm font-bold backdrop-blur-sm">
                    <Star className="w-4 h-4" /> Flagship Product
                  </span>
                )}
              </div>
              ...
              <p className="text-white/80 mb-8 leading-relaxed max-w-xl">
                AI Agents platform with 10+ pre-built agents, powered by Claude 3.5, with 500+ integrations.
                The Zapier killer for enterprise automation.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                {isAuthenticated ? (
                  ...
                  <Link href="/login?callbackUrl=/products/aether-hub">
      ...
      <section className="py-12 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { title: '10+ Pre-built Agents', description: 'Sales, Support, HR, Finance and more' },
              { title: '500+ Integrations', description: 'Connect to any enterprise tool' },
              { title: 'Claude 3.5 Powered', description: 'State-of-the-art AI reasoning' },
              { title: 'White-Label Ready', description: 'Deploy under your own brand' }
            ].map((feature, index) => (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-6">About AETHER HUB</h2>
            <p className="text-lg text-[#4a4a68] leading-relaxed mb-8">
              AETHER HUB is an enterprise-grade AI agents platform that transforms how businesses automate complex workflows. Unlike traditional automation tools like Zapier or Make that rely on simple if-then rules, AETHER HUB deploys intelligent AI agents powered by Claude 3.5 that can understand context, make decisions, and handle exceptions autonomously. Built by a team of former Anthropic, OpenAI, and Salesforce engineers, this platform represents the future of enterprise automation.
            </p>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Market Overview</h3>
            <p className="text-[#4a4a68] leading-relaxed mb-8">
              The enterprise automation market is undergoing a fundamental shift from rule-based workflows to AI-powered agents. While Zapier ($5B valuation) and UiPath ($10B market cap) dominated the previous generation of automation, they struggle with complex tasks requiring judgment and context understanding. The AI agent market is projected to reach $50B by 2030, with enterprises desperately seeking solutions that can automate not just simple tasks, but entire job functions.
            </p>
            ...
            <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-white mb-8`}>
              ...
              <p className="leading-relaxed opacity-95">
                The AI automation market is exploding, with enterprises spending over $100B annually on digital transformation initiatives. AETHER HUB targets the $50B+ automation market with a solution that delivers 10x the capability of existing tools. With enterprise contracts averaging $200K-500K annually and 90% gross margins on the SaaS model, the unit economics are exceptional. Early adopters report replacing entire teams with AI agents, driving massive demand.
              </p>
            </div>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Competitive Advantage</h3>
            <p className="text-[#4a4a68] leading-relaxed">
              AETHER HUB's technical moat includes three key innovations: First, a proprietary agent orchestration layer that enables multiple AI agents to collaborate on complex workflows, with built-in memory and learning capabilities. Second, 500+ pre-built integrations with enterprise tools (Salesforce, SAP, Workday, etc.) that enable immediate deployment without custom development. Third, Claude 3.5 integration optimized for enterprise tasks, with fine-tuned models for specific functions like sales, support, and HR. The white-label capability allows technology partners to resell under their own brand, creating a powerful distribution channel.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Why Invest in AETHER HUB?</h2>
            <p className="text-lg text-[#4a4a68]">
              Discover the key reasons why AETHER HUB represents an exceptional opportunity for investors and companies looking to enter the AI automation market with a proven, ready-to-scale solution.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              '$50B AI agent market by 2030, fastest growing segment',
              '90% gross margin, enterprise SaaS revenue',
              'Exit potential: $500M+ (AI automation multiples)'
            ].map((reason, index) => (
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              We analyze a real scenario to demonstrate the transformative impact of AETHER HUB on business results. This case study illustrates the potential ROI our clients can expect.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-red-50 border border-red-200 rounded-2xl p-6">
                <h4 className="font-bold text-red-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">❌</span> Before (Without AETHER HUB)
                </h4>
                <p className="text-red-800 text-sm mb-4">
                  Typical challenges faced before implementing our solution:
                </p>
                <ul className="space-y-3">
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">Manual processes, 10 FTEs</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">$1M/year in labor costs</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
                <h4 className="font-bold text-green-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">✅</span> After (With AETHER HUB)
                </h4>
                ...
                <ul className="space-y-3">
                  <li className="text-green-800 flex items-start gap-2">
                    ...
                    <span className="font-medium">AI agents handle 80% of tasks</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">•</span>
                    <span className="font-medium">$200K/year platform cost</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-center text-white`}>
            ...
            <p className="text-3xl font-bold mb-2">80% Cost Reduction</p>
            <p className="text-white/80 text-sm">
              $800K annual savings while improving speed and accuracy of operations
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Who is AETHER HUB For?</h2>
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              AETHER HUB has been designed with specific organizations in mind that can maximize the value of this platform. If your company fits one of these profiles, AETHER HUB may be exactly what you need.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {['Fortune 1000 Companies', 'System Integrators', 'BPO Providers', 'Technology Resellers'].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              When you acquire AETHER HUB, you receive a complete package designed for you to launch and scale your business immediately, with no hidden costs or third-party dependencies.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Full access to source code including Python/TypeScript backend, React dashboard, and all 500+ integration connectors. Pre-configured Claude 3.5 integration included. No obfuscated code, no proprietary dependencies.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                800+ pages of complete technical documentation: agent architecture, integration guides, white-label setup, enterprise deployment playbooks, and customer success frameworks.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                90 days of technical support included with our engineering team. Question resolution, deployment assistance, and customization consulting for your specific use case.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Once purchased, AETHER HUB is yours forever. No monthly payments, no royalties, no user or agent limits. Deploy on as many servers as you need.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-3xl p-8 md:p-12 text-white overflow-hidden relative`}>
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Transform Your Business with AETHER HUB?</h2>
              <p className="text-white/90 mb-4 max-w-2xl mx-auto text-lg">
                Join the leading companies already using AETHER HUB to accelerate their growth and establish lasting competitive advantages in the AI automation market.
              </p>
