...
export default function InfraSchoolPage() {
  ...
  const hasImages = platformsWithImages.includes('learn')
  const firstImageUrl = getFirstPlatformImage('learn')
  ...
  const product = {
    name: 'INFRA SCHOOL',
    icon: '🎓',
    tagline: 'Complete LMS Platform. Video Courses. Certification.',
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-white/80 mb-8 leading-relaxed max-w-xl">
                Complete Learning Management System with video course hosting, certification and badges, progress tracking, and multi-tenant architecture. Scalable to 100K+ users with optional blockchain-verified certificates.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                {isAuthenticated ? (
                  ...
                  <Link href="/login?callbackUrl=/products/infra-school">
      ...
      <section className="py-12 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { title: 'Complete LMS', description: 'Video, docs, quizzes & assignments' },
              { title: 'Certification', description: 'Badges & blockchain-verified optional' },
              { title: 'Multi-Tenant', description: 'White-label ready architecture' },
              { title: '100K+ Users', description: 'Enterprise-grade scalability' }
            ].map((feature, index) => (
        ...
        <div className="max-w-4xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <p className="text-lg text-[#4a4a68] leading-relaxed mb-8">
              INFRA SCHOOL is a comprehensive EdTech platform designed for corporate training, online academies, and educational institutions. Built with 48,000+ lines of production-ready code using TypeScript, React, Node.js, PostgreSQL, Redis, and S3 for scalable video storage. The multi-tenant architecture allows you to run multiple independent learning portals from a single deployment, each with its own branding, courses, and user base.
            </p>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Market Overview</h3>
            <p className="text-[#4a4a68] leading-relaxed mb-8">
              The global EdTech market is experiencing unprecedented growth, projected to exceed $400 billion by 2028. The COVID-19 pandemic permanently shifted learning behaviors, with 70% of organizations now investing in digital learning solutions. Corporate training alone represents a $370 billion market, while online education platforms are growing at 15% CAGR. The demand for scalable, customizable LMS solutions has never been higher, yet building one from scratch requires $1-2M in development costs and 12-18 months of engineering time.
            </p>
            ...
            <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-white mb-8`}>
              ...
              <p className="leading-relaxed opacity-95">
                The EdTech market is projected to reach $400B+ by 2028, growing at 15% CAGR. Corporate training budgets are increasing as remote work becomes permanent. Universities are investing heavily in digital infrastructure. INFRA SCHOOL positions you to capture this massive opportunity with a fraction of the typical development investment. At €500K, you're getting a platform that would cost $1-2M to build from scratch, deployable in 5-8 weeks instead of 12-18 months.
              </p>
            </div>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Competitive Advantage</h3>
            <p className="text-[#4a4a68] leading-relaxed">
              INFRA SCHOOL stands apart with its modern tech stack (TypeScript, React, Node.js) that ensures maintainability and developer productivity. The multi-tenant architecture is enterprise-ready, supporting white-label deployments for B2B clients. Video content is optimized with adaptive streaming and S3 storage for cost efficiency at scale. The certification system supports both traditional certificates and optional blockchain verification for industries requiring tamper-proof credentials. Progress tracking includes detailed analytics for learners and administrators alike.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Why Invest in INFRA SCHOOL?</h2>
            <p className="text-lg text-[#4a4a68]">
              Discover the key reasons why INFRA SCHOOL represents an exceptional opportunity for investors and companies looking to enter the rapidly growing EdTech market.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              '$400B+ EdTech market by 2028, 15% CAGR growth',
              'Save $1-2M development cost, launch in 5-8 weeks',
              'Multi-tenant architecture enables B2B SaaS model'
            ].map((reason, index) => (
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              We analyze a real scenario to demonstrate the transformative impact of INFRA SCHOOL on your time-to-market and development costs. This case study illustrates the potential ROI our clients can expect.
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-3xl p-8 mb-8 shadow-sm">
            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-6 text-center">
              📊 Corporate Training Platform Launch
            </h3>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-red-50 border border-red-200 rounded-2xl p-6">
                ...
                <p className="text-red-800 text-sm mb-4">
                  Typical challenges faced when building your own LMS:
                </p>
                <ul className="space-y-3">
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">$1-2M development cost</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">12-18 months to launch</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">Ongoing maintenance burden</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
                <h4 className="font-bold text-green-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">✅</span> After (With INFRA SCHOOL)
                </h4>
                <p className="text-green-800 text-sm mb-4">
                  Results our clients achieve after acquisition:
                </p>
                <ul className="space-y-3">
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">•</span>
                    <span className="font-medium">€500K one-time investment</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">•</span>
                    <span className="font-medium">5-8 weeks to deployment</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">•</span>
                    <span className="font-medium">Production-ready, tested codebase</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-center text-white`}>
            ...
            <p className="text-3xl font-bold mb-2">Save $500K-1.5M vs building from scratch</p>
            <p className="text-white/80 text-sm">
              Plus 10+ months faster time-to-market to capture the growing EdTech opportunity
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Who is INFRA SCHOOL For?</h2>
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              INFRA SCHOOL has been designed with specific organizations in mind that can maximize the value of this platform. If your company fits one of these profiles, INFRA SCHOOL may be exactly what you need.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {['EdTech Startups', 'Corporate Training Departments', 'Universities & Educational Institutions', 'Professional Certification Bodies'].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              When you acquire INFRA SCHOOL, you receive a complete package designed for you to deploy and scale your EdTech platform immediately, with no hidden costs or third-party dependencies.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Full access to 48,000+ lines of TypeScript, React, and Node.js code. PostgreSQL database schemas, Redis caching layer, S3 integration for video storage. No obfuscated code, no proprietary dependencies. You own it completely.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Complete technical documentation covering architecture overview, deployment guides, API references, course builder usage, certification system configuration, and multi-tenant setup instructions.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                30 days of technical support included. After that, buyer should have 1 Full-Stack Developer + 1 DevOps engineer. Deployment takes 5-8 weeks with proper planning.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Once purchased, INFRA SCHOOL is yours forever. No monthly payments, no royalties, no user limits. Deploy for as many learners and tenants as you need. Full IP transfer included.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-3xl p-8 md:p-12 text-white overflow-hidden relative`}>
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Launch Your EdTech Platform with INFRA SCHOOL?</h2>
              <p className="text-white/90 mb-4 max-w-2xl mx-auto text-lg">
                Join the growing EdTech market with a production-ready LMS platform. Skip 12-18 months of development and launch in weeks.
              </p>
              <p className="text-white/70 mb-8 max-w-xl mx-auto">
                Valuation: <span className="font-bold text-white">{formatPrice(product.priceMin)}</span>
                <br />
                <span className="text-sm">Complete platform with full IP transfer and 30 days support</span>
              </p>
