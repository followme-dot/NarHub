...
export default function AgoraSocialPage() {
  const { isAuthenticated } = useAuth()
  const [copiedIban, setCopiedIban] = useState(false)
  const [showPayment, setShowPayment] = useState(false)
  const [isOutsideEU, setIsOutsideEU] = useState(false)
  const [showDemoModal, setShowDemoModal] = useState(false)
  const hasImages = platformsWithImages.includes('agora-social')
  const firstImageUrl = getFirstPlatformImage('agora-social')
  ...
  const product = {
    ...
    priceMax: 22000000,
    flagship: false,
    gradient: { from: 'from-rose-600', to: 'to-pink-500' }
  }
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-white/80 mb-8 leading-relaxed max-w-xl">
                Decentralized social where creators keep 90% of revenue. Censorship resistant. Token incentives.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                {isAuthenticated ? (
                  ...
                  <Link href="/login?callbackUrl=/products/agora-social">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              { title: 'Decentralized Storage', description: 'IPFS + Arweave' },
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-6">About AGORA SOCIAL</h2>
            <p className="text-lg text-[#4a4a68] leading-relaxed mb-8">
              AGORA SOCIAL is a revolutionary decentralized social network that fundamentally changes how creators monetize their content. Built on blockchain technology with decentralized storage through IPFS and Arweave, the platform ensures content permanence and censorship resistance. Unlike traditional platforms that take 55% or more of creator earnings, AGORA SOCIAL allows creators to keep 90% of their revenue through smart contract-based monetization and token incentives.
            </p>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Market Overview</h3>
            <p className="text-[#4a4a68] leading-relaxed mb-8">
              The creator economy is worth over $250 billion and growing at 20% annually. However, traditional social platforms extract excessive fees and maintain centralized control over content and monetization. Creators are increasingly seeking alternatives that offer better revenue sharing, content ownership, and protection from arbitrary deplatforming. AGORA SOCIAL addresses this massive market opportunity by providing a Web3-native solution that aligns platform incentives with creator success.
            </p>
            ...
            <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-white mb-8`}>
              ...
              <p className="leading-relaxed opacity-95">
                The decentralized social media market is projected to reach $15B by 2028. With growing concerns about Big Tech censorship and data privacy, millions of users are actively seeking alternatives. AGORA SOCIAL is positioned to capture this migration with its creator-first economics and Web3 infrastructure. The token model creates network effects as early adopters earn significant rewards, driving viral growth and user acquisition at near-zero CAC.
              </p>
            </div>

            <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Competitive Advantage</h3>
            <p className="text-[#4a4a68] leading-relaxed">
              While competitors like Lens Protocol focus on infrastructure and others like Farcaster target crypto natives, AGORA SOCIAL is the only platform combining mainstream UX with decentralized benefits. Our native mobile apps for iOS and Android provide the familiar experience users expect, while blockchain backend ensures true ownership and monetization. The 90/10 revenue split is industry-leading, and our content moderation tools balance free speech with community standards through decentralized governance.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Why Invest in AGORA SOCIAL?</h2>
            <p className="text-lg text-[#4a4a68]">
              Discover the key reasons why AGORA SOCIAL represents an exceptional opportunity for investors and companies looking to enter the market with a proven, ready-to-scale solution.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              '$250B creator economy seeking better alternatives',
              '90/10 revenue split attracts top creators instantly',
              'Exit potential: $500M+ as Web3 social category leader'
            ].map((reason, index) => (
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              We analyze a real scenario to demonstrate the transformative impact of AGORA SOCIAL on creator earnings. This case study illustrates the potential ROI our platform delivers.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-red-50 border border-red-200 rounded-2xl p-6">
                <h4 className="font-bold text-red-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">❌</span> Before (YouTube)
                </h4>
                <p className="text-red-800 text-sm mb-4">
                  Typical challenges faced on traditional platforms:
                </p>
                <ul className="space-y-3">
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">$10K/month revenue</span>
                  </li>
                  <li className="text-red-800 flex items-start gap-2">
                    <span className="text-red-500 mt-1 font-bold">•</span>
                    <span className="font-medium">Platform takes 45%+ of earnings</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
                <h4 className="font-bold text-green-700 mb-4 flex items-center gap-2">
                  <span className="text-2xl">✅</span> After (AGORA SOCIAL)
                </h4>
                <p className="text-green-800 text-sm mb-4">
                  Results creators achieve on our platform:
                </p>
                <ul className="space-y-3">
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">•</span>
                    <span className="font-medium">$90K/month revenue</span>
                  </li>
                  <li className="text-green-800 flex items-start gap-2">
                    <span className="text-green-500 mt-1 font-bold">•</span>
                    <span className="font-medium">Keep 90% of all earnings</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-2xl p-8 text-center text-white`}>
            ...
            <p className="text-3xl font-bold mb-2">9x More Earnings</p>
            <p className="text-white/80 text-sm">
              Based on actual creator earnings comparisons between traditional and decentralized platforms
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-[#1a1a2e] mb-4">Who is AGORA SOCIAL For?</h2>
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              AGORA SOCIAL has been designed with specific organizations in mind that can maximize the value of this platform. If your company fits one of these profiles, AGORA SOCIAL may be exactly what you need.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {['Media Companies', 'Creator Platforms', 'VCs'].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[#4a4a68] max-w-2xl mx-auto">
              When you acquire AGORA SOCIAL, you receive a complete package designed for you to launch and scale your business immediately, with no hidden costs or third-party dependencies.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-[#1a1a2e]">Apps iOS/Android/Web</h3>
              </div>
              <p className="text-[#4a4a68]">
                Full native mobile applications for iOS and Android, plus a responsive web application. All source code included with React Native and Next.js codebases.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Audited smart contracts for token rewards, creator monetization, and governance. Deployed on Ethereum and Polygon with full documentation and upgrade capabilities.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-[#1a1a2e]">Content Moderation Tools</h3>
              </div>
              <p className="text-[#4a4a68]">
                AI-powered content moderation system with decentralized governance. Community-driven standards with transparent appeal processes and multi-language support.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              ...
              <p className="text-[#4a4a68]">
                Once purchased, AGORA SOCIAL is yours forever. No monthly payments, no royalties, no user or transaction limits. Deploy on as many servers as you need.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className={`bg-gradient-to-r ${product.gradient.from} ${product.gradient.to} rounded-3xl p-8 md:p-12 text-white overflow-hidden relative`}>
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Transform Your Business with AGORA SOCIAL?</h2>
              <p className="text-white/90 mb-4 max-w-2xl mx-auto text-lg">
                Join the leading companies already using AGORA SOCIAL to accelerate their growth and establish lasting competitive advantages in the creator economy.
              </p>
