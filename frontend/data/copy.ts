...
export const heroContent = {
  ...
  urgencyNote: "36 platforms available. Priced from $400K to $3.2M."
}
...
export const stats = [
  ...
  { value: "$47.25M", label: "Portfolio Value", context: "Total catalog valuation" },
  ...
  { value: "$400K-$3.2M", label: "Price Range", context: "Based on complexity" }
]
...
export const bundles = [
  {
    ...
    products: ["infrabank", "infra-pay-treasury", "infra-vault-core", "ferrum-pay", "veritas-id"],
    individualPrice: 9200000,
    bundlePrice: 7800000,
    discount: 15,
    color: "blue",
    featured: true
  },
  {
    ...
    products: ["nardium-dex", "aureum-vault", "infra-digital-assets", "argentum-bridge", "oraculum"],
    individualPrice: 9500000,
    bundlePrice: 8100000,
    discount: 15,
    color: "purple",
    featured: true
  },
  {
    ...
    products: ["astrid", "vigil-ai", "aether-hub", "bitboots", "infra-forge"],
    individualPrice: 11700000,
  ...
  },
  {
    ...
    products: ["infracoinn", "susinik", "templum-dao", "infra-global-insurance"],
    individualPrice: 6400000,
    bundlePrice: 5400000,
    discount: 16,
    color: "emerald",
    featured: false
  ...
  },
  {
    ...
    products: ["dolly", "infra-iam", "infra-observatory", "infra-compliance-engine", "infra-data-lake", "infra-hub", "infra-automation", "infra-devops"],
    individualPrice: 4500000,
    bundlePrice: 3600000,
    discount: 20,
    color: "cyan",
    featured: false
...
export const megaBundles = [
  {
    ...
    platformCount: 19,
    individualPrice: 27450000,
    bundlePrice: 24000000,
    discount: 13,
    color: "gradient-blue-purple"
  },
  {
    id: "infra-complete",
    name: "INFRA HOLDINGS COMPLETE",
    description: "All 17 INFRA platforms. Banking, payments, custody, compliance, and enterprise infrastructure.",
    platformCount: 17,
    individualPrice: 19800000,
    bundlePrice: 17000000,
    discount: 14,
...
export const faq = [
  ...
  {
    question: "Why the price range ($400K - $3.2M)?",
    answer: "Pricing reflects development complexity: infrastructure tools (DevOps, monitoring, communications) start at $400K. Complex platforms (DEX, custody, banking, AI trading) go up to $3.2M. All platforms are priced below what it would cost to build from scratch."
  },
  {
...
export const finalCTA = {
  ...
  subheadline: "36 platforms available. Priced $400K to $3.2M based on complexity. Professional audit required before mainnet. Your team deploys in 5-8 weeks.",
